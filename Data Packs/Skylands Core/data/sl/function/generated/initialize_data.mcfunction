...
data modify storage sl:data plot_ids set value {lobby:0,demo:3,oldschool_skyisland:1073709061,feelsbatman:1073512447,gardensofbabble:229381}

# Initialize names compound
data modify storage sl:data plot_names set value {0:"lobby",3:"demo",1073709061:"oldschool_skyisland",1073512447:"feelsbatman",229381:"gardensofbabble"}