...
data modify storage sl:data plot_ids set value {lobby:0,demo:3,oldschool_skyisland:1073709061,feelsbatman:1073512447,gardensofbabble:229381,itspungpond98:1073381377}
