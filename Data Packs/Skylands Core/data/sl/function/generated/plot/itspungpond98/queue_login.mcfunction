...
execute if score #debug_mode sl.value matches 1 if score #is_available sl.value matches 0 run tellraw @s {"text":"The plot itspungpond98 is not available","color":"red"}
