...
execute if score #plot.did.state sl.value matches 1 run return 1
execute if score #plot.did.state sl.value matches 3 run return 1
execute if score #plot.did.state sl.value matches 4 run return 1
