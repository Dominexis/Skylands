...
execute if score #debug_mode sl.value matches 1 if score #is_available sl.value matches 0 run tellraw @s {text:"The plot oldschool_skyisland is not available",color:"red",type:"text"}
