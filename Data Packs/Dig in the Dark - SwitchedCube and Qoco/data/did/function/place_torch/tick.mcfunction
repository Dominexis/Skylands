...
execute align xyz positioned ~0.5 ~ ~0.5 if entity @n[type=minecraft:item_frame,distance=..0.5] run function did:place_torch/place
execute align xyz positioned ~0.5 ~ ~0.5 if entity @n[type=minecraft:item_frame,distance=..0.5] as @n[type=minecraft:item_frame,distance=..0.5] at @s run return run kill @s
