...
execute if block ~ ~ ~ minecraft:suspicious_sand run return run function did:misc/convert_sand
execute if block ~ ~ ~ minecraft:sand run return run function did:misc/convert_sand2
execute if block ~ ~ ~ minecraft:smooth_sandstone run return run function did:misc/convert_sand2
