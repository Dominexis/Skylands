...
execute if score @s did.player.torch_burn_loop matches 0 if score @s did.player.torch_burn_time matches 1 at @s run playsound block.fire.extinguish hostile @a[team=sl.player,distance=..40] ~ ~ ~
