...
execute if score #rand synb.Tmp.Expr matches ..40 run scoreboard players add @e[x=3078,y=0,z=-2554,dx=500,dy=255,dz=500,type=!minecraft:player,tag=synb.ctx.enemy_hurt_target] synb.Status.Vulnerable 60