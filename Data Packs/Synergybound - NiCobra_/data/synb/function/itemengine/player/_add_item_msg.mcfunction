...
$tellraw @a[x=3078,y=0,z=-2554,dx=500,dy=255,dz=500,tag=synb.tmp.listener] [{"text":"[Arena] ","color":"gray"},{"selector":"@s","color":"yellow"},{"text":" obtained ","color":"white"},$(item_label),{"text":" [?]","color":"#666666","hover_event":{"action":"show_text","value":$(text_array)}}]
