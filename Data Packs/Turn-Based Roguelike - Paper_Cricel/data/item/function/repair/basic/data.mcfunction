...
data modify storage pc:temp item.components."minecraft:item_model" set value 'item:repair/basic'
data modify storage pc:temp item.sprite set value {atlas:"gui",sprite:"item:repair/basic"}
