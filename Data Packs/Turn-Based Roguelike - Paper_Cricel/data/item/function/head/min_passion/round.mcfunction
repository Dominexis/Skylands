...
function sys:utils/math/calculate {id:"entity @s data.hotbar.head.combat.turn"}
...
function sys:fx/text/use {text:{nbt:"sys.fx.boredom",storage:"pc:lang",interpret:1b}}