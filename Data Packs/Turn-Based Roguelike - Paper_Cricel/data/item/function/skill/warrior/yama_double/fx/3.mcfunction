...
execute positioned ~-1.5 ~-100 ~-1.5 as @e[tag=pc.grid,dx=2,dy=200,dz=2,type=minecraft:marker,limit=1] at @s run function item:skill/warrior/yama_double/2
tag @s add pc.void
kill @s

execute unless entity @e[tag=pc.skill.yama_double,type=marker,limit=1] run function sys:combat/turn/end_act
