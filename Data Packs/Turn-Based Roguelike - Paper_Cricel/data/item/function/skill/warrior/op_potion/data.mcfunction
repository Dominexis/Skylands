...
data modify storage pc:temp item.id set value 'warrior/op_potion'
data modify storage pc:temp item.category set value 'skill'
data modify storage pc:temp item.ep.base set value 1
data modify storage pc:temp item.db.base set value 10
...
data modify storage pc:temp item.sprite set value {atlas:"gui",sprite:"item:skill/biased_force"}
