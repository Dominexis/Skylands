...
data modify storage pc:temp item.components."minecraft:item_model" set value 'item:skill/momentum'
data modify storage pc:temp item.sprite set value {atlas:"items",sprite:"item:item/skill/momentum"}
