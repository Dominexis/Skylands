...
execute as @e[limit=1,predicate=sys:entity/player] positioned ~-0.75 ~-0.75 ~-0.75 if entity @s[dx=0,dy=0,dz=0] positioned ~0.5 ~0.5 ~0.5 if entity @s[dx=0,dy=0,dz=0] run scoreboard players set #pass pc.main 1
