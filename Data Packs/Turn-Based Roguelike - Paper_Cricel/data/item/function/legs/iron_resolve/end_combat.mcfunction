...
tellraw @a[predicate=sl:player,predicate=sys:owner/player,limit=1] ["",{text:"* Your ",color:"red"},{nbt:"data.inventory.equipment.legs.components.minecraft:item_name",storage:"pc:utils",interpret:1b},{text:" has beed destoryed.",color:"red"}]
