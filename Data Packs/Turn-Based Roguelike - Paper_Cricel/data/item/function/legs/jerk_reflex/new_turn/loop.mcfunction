...
execute if score #legs.jerk_reflex.hurt pc.main matches 1.. run function sys:entity/schedule/use {func:"function item:legs/jerk_reflex/new_turn/loop",delay:3}
