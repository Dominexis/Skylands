...
execute if function pc:sys/entity/hitbox/ally run return run function pc:entity/blaze/attack1/fx/2

execute unless function pc:sys/entity/hitbox/intent positioned ^ ^ ^4 unless function pc:sys/entity/hitbox/intent at @s run return run function pc:entity/blaze/attack1/fx/clear
