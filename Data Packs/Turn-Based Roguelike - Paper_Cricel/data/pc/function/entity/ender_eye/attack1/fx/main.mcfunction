...
execute if score @s pc.duration matches ..16 run function pc:entity/ender_eye/attack1/fx/emerge/main

execute if score @s pc.duration matches 17 run function pc:entity/ender_eye/attack1/fx/2
execute if score @s pc.duration matches 18..27 run tp @s ^ ^ ^-0.1
execute if score @s pc.duration matches 30 run function pc:entity/ender_eye/attack1/fx/3
