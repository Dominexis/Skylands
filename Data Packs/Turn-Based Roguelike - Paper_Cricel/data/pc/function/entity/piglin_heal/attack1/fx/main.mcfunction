...
tp @s ^ ^ ^1
execute if function pc:sys/entity/hitbox/ally run function pc:entity/piglin_heal/attack1/fx/hit

# execute if score @s pc.duration matches 60.. run function pc:entity/piglin_heal/attack1/fx/clear
execute unless function pc:sys/entity/hitbox/intent positioned ^ ^ ^4 unless function pc:sys/entity/hitbox/intent run function pc:entity/piglin_heal/attack1/fx/clear
