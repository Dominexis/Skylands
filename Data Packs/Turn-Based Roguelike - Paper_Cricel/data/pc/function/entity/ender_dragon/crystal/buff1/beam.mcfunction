...
particle minecraft:dust_color_transition{from_color:[0.482, 0.212, 0.773],to_color:[0.580, 0.749, 0.929],scale:2f} ~ ~ ~ 0.1 0.1 0.1 0 2 force
...
execute unless entity @e[tag=pc.atker,type=minecraft:end_crystal,distance=..0.25,limit=1] positioned ^ ^ ^0.25 run function pc:entity/ender_dragon/crystal/buff1/beam