...
execute positioned ~-1.5 ~-100 ~-1.5 store result score @e[predicate=pc:sys/entity/victim,dx=2,dy=200,dz=2,limit=1,type=!minecraft:giant] pc.damage run data get entity @s data.damage
