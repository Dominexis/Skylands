...
execute as @e[predicate=pc:sys/entity/victim,limit=1,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,type=!minecraft:giant] positioned as @s run function pc:sys/entity/repel/use

function pc:sys/grid/range/clear

data modify storage pc:temp effect set value {id:'dragonbreath_area',value:1,buffer:1b}
