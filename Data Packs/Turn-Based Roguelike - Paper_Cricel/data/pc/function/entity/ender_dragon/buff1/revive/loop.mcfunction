...
execute unless entity @e[tag=pc.entity.ender_dragon,type=minecraft:bee,distance=..0.25,limit=1] positioned ^ ^ ^0.25 run function pc:entity/ender_dragon/buff1/revive/loop