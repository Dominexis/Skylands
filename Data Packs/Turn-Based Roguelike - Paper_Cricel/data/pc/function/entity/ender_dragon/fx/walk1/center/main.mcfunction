...
execute if score @s pc.animation matches 32 run kill @e[type=minecraft:marker,tag=pc.entity.ender_dragon.walk1.center,limit=1,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0]
