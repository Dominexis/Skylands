...
execute if score @s pc.animation matches 29.. run return run function pc:entity/ender_dragon/fx/debuff2/clear

# fx
function pc:entity/ender_dragon/debuff2/charge/use