...
execute if function pc:sys/grid/range/use run return run data modify storage pc:temp intent.intents set value [{id:"attack1",weight:3},{id:"attack2",weight:2},{id:"walk1",weight:2}]
