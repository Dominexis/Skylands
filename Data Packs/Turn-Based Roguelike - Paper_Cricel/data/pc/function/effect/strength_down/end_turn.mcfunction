...
data modify storage pc:temp passive.queue append value {func:"function pc:effect/strength_down/2"}
...
function pc:sys/fx/text/use {text:{nbt:"sys.fx.strength_wear",storage:"pc:lang",interpret:1b}}