...
execute if entity @s[tag=pc.effect.void_area.clear] run return run function pc:effect/void_area/fx/clear/main
...
execute if predicate {condition:"random_chance",chance:0.25} run function pc:effect/void_area/fx/digit/use
