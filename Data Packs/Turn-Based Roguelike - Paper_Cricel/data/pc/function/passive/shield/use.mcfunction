...
execute if data storage pc:settings {gameplay:{tutorial:1b}} unless data storage pc:game tutorial.shield run schedule function pc:passive/shield/tutorial 1s