...
playsound minecraft:block.end_gateway.spawn master @a[x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,predicate=sl:player] ~ ~ ~ 1 2
particle minecraft:explosion ~ ~1 ~ 1751 0 6137 0.0015 0