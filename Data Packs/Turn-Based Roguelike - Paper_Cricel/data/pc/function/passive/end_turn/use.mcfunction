...
execute as @n[type=marker,tag=pc.grid,distance=..100] if data entity @s data.effect.dragonbreath_area run function pc:passive/end_turn/dragonbreath_area/use
