...
data modify storage pc:game combat.start_button.name set from storage pc:lang game.level.minecraft.crimson_forest
...
data modify storage pc:game combat.grid[1][5].lair set value {type:"mob",id:["hoglin","hoglin_tnt"]}
data modify storage pc:game combat.grid[5][5].lair set value {type:"mob",id:["piglin_heal"]}
data modify storage pc:game combat.grid[0][2].lair set value {type:"mob",id:["hoglin","hoglin_tnt"]}
data modify storage pc:game combat.grid[1][0].lair set value {type:"mob",id:["piglin_heal"]}
