...
data modify storage pc:game combat.start_button.name set from storage pc:lang game.level.minecraft.nether
...
#data modify storage pc:game combat.grid[4][0].lair set value {type:"mob",id:["slime_grumpy"]}
#data modify storage pc:game combat.grid[4][4].lair set value {type:"mob",id:["slime_grumpy"]}
data modify storage pc:game combat.grid[6][2].lair set value {type:"mob",id:["piglin_heal"]}
