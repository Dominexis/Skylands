...
data modify storage pc:game shop.trader set value {rotation:-180f,name:[{text:"Armor Store"}],skin:{profession:"minecraft:weaponsmith",type:"minecraft:plains",head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{name:"_Chong_ya_"}}}}}
data modify storage pc:game shop.trader.items.loot_table set value 'armor'
data modify storage pc:game shop.trader.items.item append value {slot:11,is_sell:true,price_range:'15..28'}
data modify storage pc:game shop.trader.items.item append value {slot:13,is_sell:true,price_range:'15..28'}
data modify storage pc:game shop.trader.items.item append value {slot:15,is_sell:true,price_range:'15..28'}
execute positioned 2546 1 5558 summon villager run function pc:sys/game/rest_area/trader/summon

data modify storage pc:game shop.trader set value {rotation:-180f,name:[{text:"Traveler's Store"}],skin:{profession:"minecraft:cartographer",type:"minecraft:taiga",head:{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{properties:[{name:"textures",value:""}]}}}}}
data modify storage pc:game shop.trader.items.loot_table set value 'travel'
data modify storage pc:game shop.trader.items.item append value {slot:12,is_sell:true,price_range:'20..32'}
data modify storage pc:game shop.trader.items.item append value {slot:14,is_sell:true,price_range:'20..32'}
execute positioned 2534 1 5558 summon villager run function pc:sys/game/rest_area/trader/summon
