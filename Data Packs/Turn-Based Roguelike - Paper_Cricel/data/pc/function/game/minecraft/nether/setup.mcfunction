...
data modify storage pc:game combat.grid set value [[{type:"hole"},{type:"hole"},{type:"spac"},{type:"hole"},{type:"hole"}],[{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],[{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],[{type:"spac"},{type:"wall"},{type:"wall"},{type:"wall"},{type:"spac"}],[{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],[{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],[{type:"hole"},{type:"hole"},{type:"spac"},{type:"hole"},{type:"hole"}]]
