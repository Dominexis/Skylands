...
data modify storage pc:game combat.grid set value [[{type:"  "},{type:"  "},{type:"spac"},{type:"wall"},{type:"spac"},{type:"spac"},{type:"  "}],[{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],[{type:"spac"},{type:"spac"},{type:"hole"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],[{type:"spac"},{type:"hole"},{type:"hole"},{type:"spac"},{type:"spac"},{type:"hole"},{type:"spac"}],[{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"hole"},{type:"hole"},{type:"spac"}],[{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],[{type:"  "},{type:"spac"},{type:"wall"},{type:"wall"},{type:"spac"},{type:"spac"},{type:"spac"}]]
