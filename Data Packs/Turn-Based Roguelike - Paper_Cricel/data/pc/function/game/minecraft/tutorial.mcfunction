...
data modify storage pc:game combat.type set value 'tutorial'

data modify storage pc:game combat.start_button.name set from storage pc:lang game.level.minecraft.tutorial
data modify storage pc:game combat.start_button.icon set value 'knowledge_book'

data modify storage pc:game combat.reward set value {money:"15..19",chest:"common"}
