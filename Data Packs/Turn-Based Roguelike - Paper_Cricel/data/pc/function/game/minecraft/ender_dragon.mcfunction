...
data modify storage pc:game combat.type set value 'boss'

data modify storage pc:game combat.start_button.name set from storage pc:lang game.level.minecraft.ender_dragon
...
data modify storage pc:game combat.grid[3][1].lair set value {type:"mob",id:["ender_dragon/crystal"]}
data modify storage pc:game combat.grid[3][5].lair set value {type:"mob",id:["ender_dragon/crystal"]}
