...
data modify storage pc:game combat.start_button.name set from storage pc:lang game.level.minecraft.stronghold
...
data modify storage pc:game combat.grid[1][1].lair set value {type:"mob",id:["ender_eye"]}
data modify storage pc:game combat.grid[1][5].lair set value {type:"mob",id:["ender_eye"]}
