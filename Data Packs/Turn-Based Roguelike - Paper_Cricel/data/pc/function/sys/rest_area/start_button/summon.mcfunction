...
$execute positioned $(start_button) run function pc:sys/rest_area/start_button/summon/2 with storage pc:temp current
$execute positioned $(exit_game) run function pc:sys/rest_area/start_button/summon/exit_game
