...
execute unless data storage pc:game combat.start_button.lvls run data modify storage pc:game combat.start_button.lvls set value [{text:"◆    ["},{score:{name:"$level",objective:"pc.game"}},{text:"/"},{score:{name:"$levelmax",objective:"pc.game"}},{text:"]    ◆\n"}]
