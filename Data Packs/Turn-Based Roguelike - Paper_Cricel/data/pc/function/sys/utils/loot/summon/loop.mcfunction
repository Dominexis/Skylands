...
function pc:sys/utils/loot/summon/2 with storage pc:utils loot.curr

data remove storage pc:utils loot.slots[0]
data remove storage pc:utils loot.loots[0]

execute if data storage pc:utils loot.slots[0] if data storage pc:utils loot.loots[0] run function pc:sys/utils/loot/summon/loop