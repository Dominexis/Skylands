...
execute if score #pass pc.main matches 0 anchored eyes run data modify block ^ ^ ^ lock set value {items:"command_block",count:1}

    # Pass
execute if score #pass pc.main matches 1 anchored eyes run particle end_rod ^ ^ ^ 0 0 0 0 0 force
