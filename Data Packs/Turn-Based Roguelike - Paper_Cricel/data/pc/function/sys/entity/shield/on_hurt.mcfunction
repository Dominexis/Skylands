...
execute if score @s pc.shield matches 0.. run function pc:sys/entity/shield/on_hurt/block
execute if score @s pc.shield matches ..-1 run function pc:sys/entity/shield/on_hurt/break
