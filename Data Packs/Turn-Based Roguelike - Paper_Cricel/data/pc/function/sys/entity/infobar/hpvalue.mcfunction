...
execute if score #value pc.shield matches 1.. run return run data modify storage pc:temp infobar.hpvalue set value [{text:"",color:"#f95353",bold:1b},{"font":"pc:sys/icon",text:"1 ",shadow_color:0,color:"white",bold:0b},{score:{name:"#value",objective:"pc.hp"}},{text:"(",color:"#50c6e3"},{score:{name:"#value",objective:"pc.shield"},color:"#50c6e3"},{text:")",color:"#50c6e3"},{text:"/"},{score:{name:"#value",objective:"pc.hpmax"}},{text:" HP"},{"font":"pc:sys/icon",text:" 1",shadow_color:0,color:"white",bold:0b},{text:"\n"}]
