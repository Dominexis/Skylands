...
execute if entity @s[tag=pc.intent.icon.clear] run return run function pc:sys/entity/intent/icon/clear/main
execute if entity @s[tag=pc.intent.icon.grid] run function pc:sys/entity/intent/icon/grid/main
