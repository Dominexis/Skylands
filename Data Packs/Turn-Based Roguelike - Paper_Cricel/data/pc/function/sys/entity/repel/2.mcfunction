...
# if (stayable == false) :
execute store success score #is_diagonal pc.main run function pc:sys/entity/rotate/is_diagonal
execute unless function pc:sys/entity/repel/is run return fail

# else :
function pc:sys/utils/passive/use {passive:"on_repel"}
...
execute positioned 0.0 0.0 0.0 rotated ~ 0 summon minecraft:marker run function pc:sys/entity/repel/2b
