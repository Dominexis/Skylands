...
execute store success score #has_walk pc.main if entity @n[type=minecraft:marker,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,tag=pc.walk.intent]
