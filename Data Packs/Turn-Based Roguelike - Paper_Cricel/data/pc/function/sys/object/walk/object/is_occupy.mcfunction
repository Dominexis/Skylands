...
# effect
execute store success score #is_occupy pc.main positioned ~-1.5 ~-100 ~-1.5 as @n[type=minecraft:marker,dx=2,dy=200,dz=2,tag=pc.grid] if data entity @s data.occupy
