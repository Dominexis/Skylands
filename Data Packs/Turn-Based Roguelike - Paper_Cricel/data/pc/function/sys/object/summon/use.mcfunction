...
execute if data storage pc:temp {summon:{invisible:true}} run effect give @s invisibility infinite 0 true
execute summon text_display run function pc:sys/object/hover_info/summon
