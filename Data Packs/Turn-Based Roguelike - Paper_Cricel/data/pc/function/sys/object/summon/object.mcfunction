...
data merge entity @s {Silent:1b,Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,Rotation:[0.0f,0.0f],drop_chances:{mainhand:0.0f,offhand:0.0f,head:0.0f,chest:0.0f,legs:0.0f,feet:0.0f}}
