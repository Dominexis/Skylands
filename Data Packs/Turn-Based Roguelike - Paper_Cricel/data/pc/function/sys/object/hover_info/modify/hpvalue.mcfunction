...
# Modify
data modify storage pc:temp hover.display.hpvalue set value [{text:"",color:"#f95353",bold:1b},{text:"❤ ",bold:0b},{nbt:"hover.float.hp",storage:"pc:temp"},{text:"/"},{nbt:"hover.float.hpmax",storage:"pc:temp"},{text:" HP"},{text:" ❤\n",bold:0b}]
execute if data entity @s data.shield run data modify storage pc:temp hover.display.hpvalue set value [{text:"",color:"#f95353",bold:1b},{font:"pc:default",text:"1 ",shadow_color:0,color:"white",bold:0b},{nbt:"hover.float.hp",storage:"pc:temp"},{text:"(",color:"#50c6e3"},{nbt:"hover.float.shield",storage:"pc:temp",color:"#50c6e3"},{text:")",color:"#50c6e3"},{text:"/"},{nbt:"hover.float.hpmax",storage:"pc:temp"},{text:" HP"},{font:"pc:default",text:" 1",shadow_color:0,color:"white",bold:0b},{text:"\n"}]
