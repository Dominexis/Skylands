...
ride @s mount @e[type=!player,tag=pc.summon,limit=1,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0]

execute as @e[type=!player,tag=pc.summon,limit=1,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0] run function pc:sys/object/hover_info/modify