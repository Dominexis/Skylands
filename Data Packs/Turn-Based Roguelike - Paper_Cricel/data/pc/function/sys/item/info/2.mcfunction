...
execute unless data storage pc:temp infocheck.effects run return run function pc:sys/item/info/2b
...
function pc:sys/effect/checker/update/loop with storage pc:temp infocheck.effects[0]
