...
# shop item
execute if items entity @s contents *[minecraft:custom_data~{pc:{category:"shop/campfire"}}] run function pc:sys/game/rest_area/campfire/refresh/drop
...
tag @a[x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,tag=pc.temp,limit=1,predicate=sl:player] remove pc.temp