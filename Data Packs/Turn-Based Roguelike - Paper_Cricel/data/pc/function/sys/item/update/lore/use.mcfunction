...
execute if data storage pc:temp item.db.base run data modify storage pc:temp update.lore.result append value [{"text":"● ","color":"#72BD7A"},{"color":"gray","nbt":"sys.lore.db.value","storage":"pc:lang"},{"color":"gray","text":" : "},{"color":"gray","nbt":"item.db.max","storage":"pc:temp"},{"font":"pc:sys/icon","text":"\ue00b1","color":"white"}]
...
execute if data storage pc:temp item.rarity run function pc:sys/item/update/lore/rarity with storage pc:temp item
...
function pc:sys/item/update/lore/category with storage pc:temp item
...
function pc:sys/item/update/lore/interpret
