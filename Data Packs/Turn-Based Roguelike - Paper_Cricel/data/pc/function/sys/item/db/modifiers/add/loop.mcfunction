...
execute if data storage pc:temp item.processed_modifiers[0] run function pc:sys/item/db/modifiers/add/loop with storage pc:temp item.processed_modifiers[0]