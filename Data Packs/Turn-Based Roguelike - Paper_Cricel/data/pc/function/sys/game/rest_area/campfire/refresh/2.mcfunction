...
# merchandise
execute if data storage pc:game {shop:{campfire:{is_sell:{cure:1b}}}} run loot replace block ~ ~ ~ container.11 loot pc:shop/campfire/cure
...
execute if data storage pc:game {shop:{campfire:{is_sell:{hpmax:1b}}}} run loot replace block ~ ~ ~ container.13 loot pc:shop/campfire/hpmax
...
execute if data storage pc:game {shop:{campfire:{is_sell:{epmax:1b}}}} run loot replace block ~ ~ ~ container.15 loot pc:shop/campfire/epmax
