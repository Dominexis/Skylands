...
data modify storage pc:temp actionbar.display.hp set value [{color:"#f95353",text:""},{font:"pc:default",text:"8",color: "white"},{text:" HP ",bold: true},{text:"["},{score: {name: "#value",objective: "pc.hp"}},{text:"/"},{score: {name: "#value",objective: "pc.hpmax"}},{text:"]"}]
