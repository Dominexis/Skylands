...
execute if score #offset pc.main matches 1.. run function pc:sys/game/rest_area/player/title/offset
    ...
    # Display 
title @s actionbar ["",{nbt:"actionbar.display.offset_front[]",storage: "pc:temp",interpret: true,separator: ""},{font:"pc:default",text:"5",shadow_color: 0},{text:"\uf200\uf050\uf0076\ue100\ue050",font:"pc:default",shadow_color:0},{nbt:"actionbar.display.offset_back[]",storage: "pc:temp",interpret: true,separator: ""},{text: "◇ "},{nbt:"actionbar.display.hp",storage: "pc:temp",interpret: true}," ",{nbt:"actionbar.display.energy",storage: "pc:temp",interpret: true}," ",{nbt:"actionbar.display.money",storage: "pc:temp",interpret: true},{text: " ◇"}]
