...
execute as @a[x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,tag=pc.sys.looter,limit=1,predicate=sl:player] if predicate {"condition": "minecraft:entity_properties", "entity": "this", "predicate": {"slots": {"player.cursor": {"predicates": {"minecraf": "custom_data\":\"{pc:{sys.shop:true}}\""}}}}} run scoreboard players set #temp pc.main 1
execute as @a[x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,tag=pc.sys.looter,limit=1,predicate=sl:player] if predicate {"condition": "minecraft:entity_properties", "entity": "this", "predicate": {"slots": {"weapon.offhand": {"predicates": {"minecraf": "custom_data\":\"{pc:{sys.shop:true}}\""}}}}} run scoreboard players set #temp pc.main 2
execute as @a[x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,tag=pc.sys.looter,limit=1,predicate=sl:player] if predicate {"condition": "minecraft:entity_properties", "entity": "this", "predicate": {"slots": {"container.*": {"predicates": {"minecraf": "custom_data\":\"{pc:{sys.shop:true}}\""}}}}} run scoreboard players set #temp pc.main 3
