...
# effect
data modify storage pc:temp actionbar.display.money set value ["",{font:"pc:default",text:"4"},{color:"#f4cd72",text:" Money ",bold: true},{color:"#f4cd72",text:"["},{color:"#f4cd72",score: {name: "$game.money",objective: "pc.main"}},{color:"#f4cd72",text:"]"}]
