...
data modify storage pc:temp actionbar.hp set value [{color:"#f95353",text:""},{"font":"pc:sys/icon","text":"2",color:"white"},{nbt:"sys.hud.hp",storage:"pc:lang",interpret:1b},{text:"[",font:"pc:sys/default"},{score:{name:"#value",objective:"pc.hpmax"},font:"pc:sys/default"},{text:"]",font:"pc:sys/default"}]
