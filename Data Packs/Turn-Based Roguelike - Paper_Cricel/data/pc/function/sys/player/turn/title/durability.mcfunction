...
# effect
# Value
execute as @n[type=!minecraft:player,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,tag=pc.player.now,predicate=pc:object/ally_player] run data modify storage pc:temp actionbar.object set from entity @s data
...
data modify storage pc:temp actionbar.display.durability set value ["",{font:"pc:default",text:"1"},{color:"#3fa0e1",text:" Durability ",bold:1b},{color:"#3fa0e1",text:"["},{nbt:"actionbar.display.durability_part",storage:"pc:temp",interpret:1b},{color:"#3fa0e1",text:"]"}]