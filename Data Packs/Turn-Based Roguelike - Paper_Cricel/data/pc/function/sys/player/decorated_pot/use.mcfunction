...
# fx
tellraw @s ["",{color:"gray",text:"* A huge thank you to 虛樗SY and 小雪虎 for finding this bug! :D",type:"text"}]
tellraw @s [{translate:"block.minecraft.decorated_pot",type:"translatable"}," is slain by ",{selector:"@s",type:"selector"}]
