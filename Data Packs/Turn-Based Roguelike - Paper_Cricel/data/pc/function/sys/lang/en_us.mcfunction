...
data modify storage pc:lang sys.lore.option.campfire.hpmax set value {"text": "","italic": false,"color": "white","extra": ["Increase 3 ",{"text": "Max HP","color": "#F1DE61"},{"font":"pc:sys/icon","text":"2","color": "white"},"."]}
data modify storage pc:lang sys.item.option.campfire.epmax set value {"text": "Energy Boost"}
data modify storage pc:lang sys.lore.option.campfire.epmax set value {"text": "","italic": false,"color": "white","extra": ["Increase 1 ",{"text": "Max Energy","color": "#F1DE61"},{"font":"pc:sys/icon","text":"0","color": "white"},"."]}
...
function pc:sys/lang/nouns/en_us
...
data modify storage pc:lang sys.lobby.author.twitter set value [{text:" ",color:"gray",type:"text"},{text:"● ",color:"#72BD7A",type:"text"},{text:"\uf002 ","font":"pc:sys/icon",shadow_color:0,color:"white",type:"text"},{text:"Twitter : ",type:"text"},{text:"@CricelPaper",click_event:{action:"open_url",url:"https://x.com/CricelPaper"},underlined:1b,hover_event:{action:"show_text",value:[{text:"Click Me Open Link!",type:"text"}]},type:"text"}]
...
data modify storage pc:lang sys.lobby.settings.ascension.tough_enemies.label set value [{text:"",font:"pc:sys/modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.tough_enemies.desc",storage:"pc:lang",interpret:1b}}},{text:" Tough Enemies : ",font:"minecraft:default"}]
data modify storage pc:lang sys.lobby.settings.ascension.tough_enemies.desc set value ["All enemies have 10% more ",{text:"HP",color:"#F1DE61"},{text:"2",font:"pc:sys/icon"},"."]
data modify storage pc:lang sys.lobby.settings.ascension.poor_elites.label set value [{text:"",font:"pc:sys/modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.poor_elites.desc",storage:"pc:lang",interpret:1b}}},{text:" Poor Elites : ",font:"minecraft:default"}]
data modify storage pc:lang sys.lobby.settings.ascension.poor_elites.desc set value ["Elites drop 25% less ",{text:"Money",color:"#F1DE61"},{text:"3",font:"pc:sys/icon"},"."]
data modify storage pc:lang sys.lobby.settings.ascension.lost_slots.label set value [{text:"",font:"pc:sys/modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.lost_slots.desc",storage:"pc:lang",interpret:1b}}},{text:" Lost Slots : ",font:"minecraft:default"}]
...
data modify storage pc:lang sys.lobby.end.hp set value [{color:"gray",text:" HP"},{"font":"pc:sys/icon","text":"2",type:"text",color:"white"}]
data modify storage pc:lang sys.lobby.end.energy set value [{color:"gray",text:" Energy"},{"font":"pc:sys/icon","text":"0",type:"text",color:"white"}]
data modify storage pc:lang sys.lobby.end.item_slot set value [{color:"gray",text:" "},{text:"\ue001",font:"pc:sys/space"},{text:"ɪ"},{text:"\ue001",font:"pc:sys/space"},{text:"ᴛᴇᴍ ꜱʟᴏᴛ : "}]
data modify storage pc:lang sys.lobby.end.equipment set value {color:"gray",text:" ᴇꞯᴜɪᴘᴍᴇɴᴛ : "}
data modify storage pc:lang sys.lobby.end.money set value [{color:"gray",text:" ᴍᴏɴᴇʏ"},{text:"\ue006",font:"pc:sys/space"},{text:" : "}]
...
data modify storage pc:lang sys.hud.hp set value {text:" HP ",font:"pc:sys/default",bold:1b}
data modify storage pc:lang sys.hud.energy set value {color:"gold",text:" Energy ",font:"pc:sys/default",bold:1b}
data modify storage pc:lang sys.hud.money set value {color:"#f4cd72",text:" Money ",font:"pc:sys/default",bold:1b}
data modify storage pc:lang sys.hud.durability set value {color:"#3fa0e1",text:" Durability ",font:"pc:sys/default",bold:1b}
data modify storage pc:lang sys.hud.enemy_turn set value {text:"ᴇɴᴇᴍʏ ᴛᴜʀɴ",color:"#CE76DA",font:"pc:sys/default"}
data modify storage pc:lang sys.hud.your_turn set value {text:"ʏᴏᴜʀ ᴛᴜʀɴ",color:"#71EDA5",font:"pc:sys/default"}
...
# Rest-area actionbar offsets (pc:sys/space px; tune per language so the bar fits the labels)
...
data modify storage pc:lang lore.chest.repair_core set value [[{color:"gray",text:"ꜰᴏʀ ᴇᴀᴄʜ ᴀɴᴠɪʟ ɪɴ "},{color:"#d983f4",text:"ʀᴇᴘᴀɪʀ ᴍᴏᴅᴇ"},{color:"gray",text:" :"}],["Gain 2 ",{color:"#7ABFF1",text:"Strength"}," this turn."],[],[{color:"gray",text:"ꜱᴛᴀʀᴛ ᴇᴀᴄʜ ᴄᴏᴍʙᴀᴛ :"}],["Increase 1 ",{color:"#F1DE61",text:"Max Durability"},{"font":"pc:sys/icon","text":"1"}," of all ",{color:"#D983F4",text:"Skill Item"},"."]]

data modify storage pc:lang item.feet.energy_surge set value {"text":"Energy Surge"}
data modify storage pc:lang lore.feet.energy_surge set value [[{color:"gray",text:"ᴡʜᴇɴᴇᴠᴇʀ ᴀɴʏ ɪᴛᴇᴍ'ꜱ "},{color:"#F1DE61",text:"ᴅᴜʀᴀʙɪʟɪᴛʏ"},{font:"pc:sys/icon",text:"1"},{color:"gray",text:" ɪꜱ ᴄᴏɴꜱᴜᴍᴇᴅ :"}],["Deal (",{color:"#F1DE61",text:"Energy"},{font:"pc:sys/icon",text:"0"},") damage to all"],["enemies within ",{color:"#7ABBF1",text:"3x3 block"},"."],[],[{color:"gray",text:"ᴏɴ ᴜꜱᴇ ᴀɴ ɪᴛᴇᴍ ᴡɪᴛʜ "},{color:"#F1DE61",text:"ᴇɴᴇʀɢʏ"},{font:"pc:sys/icon",text:"0"},{color:"gray",text:" ᴄᴏꜱᴛ 2 ᴏʀ ᴍᴏʀᴇ :"}],["this item's ",{color:"#F1DE61",text:"Durability"},{font:"pc:sys/icon",text:"1"}," will not be lost."],["Can only trigger once per turn."],[{color:"#72BD7A",text:"● "},{color:"gray",text:"ᴛʜɪꜱ ᴛᴜʀɴ : "},{nbt:"item.combat.this_turn",storage:"pc:temp",interpret:1b}]]

data modify storage pc:lang item.feet.footwork set value {"text":"Footwork"}
data modify storage pc:lang lore.feet.footwork set value [[{color:"gray",text:"ᴛʜᴇ 4ᴛʜ ɪᴛᴇᴍ ᴜꜱᴇᴅ ᴇᴀᴄʜ ᴛᴜʀɴ :"}],[{color:"#f1de61",text:"Durability"},{"font":"pc:sys/icon","text":"1"}," will not be lost."],[{color:"#72BD7A",text:"●"},{color:"gray",text:" ᴛɪᴍᴇꜱ : ",extra:[{nbt:"item.combat.times",storage:"pc:temp"}]}],[],[{color:"gray",text:"ꜱᴛᴀʀᴛ ᴇᴀᴄʜ ᴄᴏᴍʙᴀᴛ :"}],["Increase 2 ",{color:"#f1de61",text:"Max Durability"},{"font":"pc:sys/icon","text":"1"}," of ",{color:"#D983F4",text:"Move Item"},"."]]

data modify storage pc:lang item.feet.vigilance set value {"text":"Vigilance"}
data modify storage pc:lang lore.feet.vigilance set value [[{color:"gray",text:"ꜱᴛᴀʀᴛ ᴏꜰ ᴇᴀᴄʜ ᴛᴜʀɴ :"}],["Increase 1 ",{color:"#F1DE61",text:"Max Durability"},{font:"pc:sys/icon",text:"1"}," of ",{color:"#D983F4",text:"Move Item"}],["this turn for each enemy within a ",{color:"#7ABBF1",text:"9-block"}],[{color:"#7ABBF1",text:"cross"},"."],[],[{color:"gray",text:"ᴇɴᴅ ᴏꜰ ᴇᴀᴄʜ ᴛᴜʀɴ :"}],["Convert each ",{color:"#f1de61",text:"Durability"},{font:"pc:sys/icon",text:"1"}," of ",{color:"#D983F4",text:"Move Item"}],["into 3 ",{color:"#7ABBF1",text:"Vigor"},"."]]

data modify storage pc:lang item.head.frenzied set value {"text":"Frenzied"}
data modify storage pc:lang lore.head.frenzied set value [[{color:"gray",text:"ᴇᴠᴇʀʏ 4ᴛʜ ᴀᴛᴛᴀᴄᴋ :"}],["Double the attack damage."],["Gain 1 ",{color:"#F1DE61",text:"Energy"},{font:"pc:sys/icon",text:"0"},"."],[{color:"#72BD7A",text:"● "},{color:"gray",text:"ᴄᴏᴜɴᴛ : "},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]

data modify storage pc:lang item.head.gold_greed set value {"text":"Gold Greed"}
data modify storage pc:lang lore.head.gold_greed set value [[{color:"gray",text:"ᴇɴᴅ ᴏꜰ ᴄᴏᴍʙᴀᴛ:"}],["Gain 50% additional ",{color:"#F1DE61",text:"Money"},{"font":"pc:sys/icon","text":"3"},"."],[],[{color:"gray",text:"ᴏɴ ᴋɪʟʟ :"}],["Gain 3 ",{color:"#F1DE61",text:"Money"},{"font":"pc:sys/icon","text":"3"}," if the enemy"],["is not ",{color:"#7ABFF1",text:"Minion"},"."]]

data modify storage pc:lang item.head.min_passion set value {"text":"3 Minute Passion"}
data modify storage pc:lang lore.head.min_passion set value [[{color:"gray",text:"ꜱᴛᴀʀᴛ ᴇᴀᴄʜ ᴄᴏᴍʙᴀᴛ :"}],["Gain 3 ",{color:"#7ABFF1",text:"Strength"},". Gain 3 ",{color:"#F1DE61",text:"Energy"},{"font":"pc:sys/icon","text": "0"},"."],[],[{color:"gray",text:"ɪꜰ ɴᴏ ᴀɴʏᴏɴᴇ ᴅɪᴇꜱ ɪɴ 3 ᴛᴜʀɴ :"}],["Lose 1 ",{color:"#7ABFF1",text:"Strength"},". Lose 1 ",{color:"#F1DE61",text:"Energy"},{"font":"pc:sys/icon","text": "0"},"."],[{color:"#72BD7A",text:"●"},{color:"gray",text:" ᴛᴜʀɴ : ",extra:[{nbt:"item.combat.turn",storage:"pc:temp"}]}]]

data modify storage pc:lang item.legs.iron_resolve set value {"text":"Iron Resolve"}
data modify storage pc:lang lore.legs.iron_resolve set value [[{color:"gray",text:"ɪꜰ "},{color:"#F1DE61",text:"ʜᴘ"},{"font":"pc:sys/icon","text":"2"},{color:"gray",text:" ɪꜱ ʙᴇʟᴏᴡ 50% :"}],["Deal 50% more damage. Restore 1 ",{color:"#F1DE61",text:"HP"},{"font":"pc:sys/icon","text":"2"}],["at the start of your turn."],[],[{color:"gray",text:"ᴀᴛ ʏᴏᴜʀ 1ꜱᴛ ᴅᴇᴀᴛʜ :"}],["Set ",{color:"#F1DE61",text:"HP"},{"font":"pc:sys/icon","text":"2"}," to 1. This item is destroyed"],["at the end of combat."]]

data modify storage pc:lang item.legs.jerk_reflex set value {"text":"Knee Jerk Reflex"}
data modify storage pc:lang lore.legs.jerk_reflex set value [[{color:"gray",text:"ꜱᴛᴀʀᴛ ᴏꜰ ʏᴏᴜʀ ᴛᴜʀɴ :"}],["Gain 2 ",{color:"#7ABFF1",text:"Shield"}," for each attack"],["received at previous turn."],[],[{color:"gray",text:"ᴏɴ ʟᴏꜱᴇ "},{color:"#f1de61",text:"ʜᴘ"},{"font":"pc:sys/icon","text":"2"},{color:"gray",text:" :"}],["Lose 1 less."]]

data modify storage pc:lang item.legs.residual_defense set value {"text":"Residual Defense"}
data modify storage pc:lang lore.legs.residual_defense set value [[{color:"gray",text:"ᴇɴᴅ ᴏꜰ ʏᴏᴜʀ ᴛᴜʀɴ :"}],["Convert each remaining ",{color:"#f1de61",text:"Energy"},{"font":"pc:sys/icon","text": "0"}," into 3 ",{color:"#7ABFF1",text:"Shield"},"."],["If ",{color:"#f1de61",text:"Energy"},{"font":"pc:sys/icon","text": "0"}," is 4 or more, ",{color:"#7abbf1",text:"Shield"}," won't removed"],["at the start of your next turn."]]

# Items

    # Move
data modify storage pc:lang item.move.basic set value {"text":"Move"}
data modify storage pc:lang lore.move.basic set value [["Move 1 block."],[],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ :"}],["Restore all ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."]]

data modify storage pc:lang item.move.bishop set value {"text":"Bishop"}
data modify storage pc:lang lore.move.bishop set value [["Move 1 block."],["Can select within ",{color:"#7ABBF1",text:"3x3 block"},"."],[],[{color:"gray",text:"ᴀʟʟ "},{color:"#D983F4",text:"ꜱᴋɪʟʟ ɪᴛᴇᴍ"},{color:"gray",text:" :"}],["Can additionally select within"],["a diagonal ",{color:"#7ABBF1",text:"1-block cross"},"."],[],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ :"}],["Restore all ",{color:"#F1DE61",text:"Durability"},{font:"pc:sys/icon",text:"1"},"."]]

data modify storage pc:lang item.move.ender_pearl set value {"text":"Ender Pearl"}
data modify storage pc:lang lore.move.ender_pearl set value [["Move 1 block. Can select within ",{color:"#7ABBF1",text:"7x7 block"},"."],["If no ",{color:"#7abbf1",text:"Phantom"}," exist, lose 1 ",{color:"#f1de61",text:"HP"},{font:"pc:sys/icon",text:"2"}," and summon"],[{color:"#7abbf1",text:"Phantom"}," (1 ",{color:"#f1de61",text:"HP"},{font:"pc:sys/icon",text:"2"},") at previous position."],[],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ :"}],["Restore all ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."]]
...
data modify storage pc:lang lore.repair.basic set value [["Summon ",{color:"#7abbf1",text:"Anvil"}," (6 ",{color:"#F1DE61",text:"HP"},{color:"white",font:"pc:sys/icon",text:"2"},")."],["It takes 2 rounds to repair 3 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."],[],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ :"}],["Restore 1 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."]]

data modify storage pc:lang item.repair.magma set value {"text":"Magma Anvil"}
data modify storage pc:lang lore.repair.magma set value [["Summon ",{color:"#7abbf1",text:"Anvil"}," (12 ",{color:"#F1DE61",text:"HP"},{color:"white",font:"pc:sys/icon",text:"2"},")."],["It takes 2 rounds to repair 3 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."],["It is immune to ",{color:"#7abbf1",text:"Fire Area"}," damage."],[],[{color:"gray",text:"ᴏɴ ᴀɴᴠɪʟ ᴅᴇᴀᴛʜ :"}],["It releases 4 ",{color:"#7abbf1",text:"Fire Area"}," in ",{color:"#7ABBF1",text:"1-block cross"},"."],[],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ :"}],["Restore 1 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."]]

data modify storage pc:lang item.repair.rugged set value {"text":"Rugged Anvil"}
data modify storage pc:lang lore.repair.rugged set value [["Summon ",{color:"#7abbf1",text:"Anvil"}," (18 ",{color:"#F1DE61",text:"HP"},{color:"white",font:"pc:sys/icon",text:"2"},")."],["It takes 3 rounds to repair all ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."],["Every turn, it applies 3 ",{color:"#7ABBF1",text:"Shield"}," to all allies"],["within ",{color:"#7ABBF1",text:"3x3 block"},"."],[],[{color:"gray",text:"ᴡʜᴇɴ ᴀɴᴠɪʟ ꜰᴜʟʟʏ ʀᴇᴘᴀɪʀᴇᴅ :"}],["Gain 2 ",{color:"#F1DE61",text:"Energy"},{font:"pc:sys/icon",text:"0"},"."],[],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ :"}],["Restore 1 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."]]

data modify storage pc:lang item.repair.curious set value {"text":"Curious Anvil"}
data modify storage pc:lang lore.repair.curious set value [["Summon ",{color:"#7abbf1",text:"Anvil"}," (",{nbt:"item.combat.hpmax",storage:"pc:temp"}," ",{color:"#F1DE61",text:"HP"},{color:"white",font:"pc:sys/icon",text:"2"},")."],["It takes 2 rounds to repair 3 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."],[{italic:false,color:"white",text:""}],[{color:"gray",text:"ᴡʜᴇɴ ᴀɴᴠɪʟ ꜰᴜʟʟʏ ʀᴇᴘᴀɪʀᴇᴅ :"}],["If has enemy within ",{color:"#7ABBF1",text:"1-block cross"},","],["the repairer gain 2 ",{color:"#7ABBF1",text:"Strength"},"."],[{italic:false,color:"white",text:""}],[{color:"gray",text:"ᴡʜᴇɴ ᴀɴᴠɪʟ ᴋɪʟʟᴇᴅ ʙʏ ᴀɴʏᴏɴᴇ :"}],["Summoned ",{color:"#7abbf1",text:"Anvil"}," increase 2 ",{color:"#F1DE61",text:"Max HP"},{font:"pc:sys/icon",text:"2"},","],["the repairer gain 1 ",{color:"#F1DE61",text:"Energy"},{color:"white",font:"pc:sys/icon",text:"0"}," next turn."],[{italic:false,color:"white",text:""}],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ :"}],["Restore 1 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."]]

data modify storage pc:lang item.repair.wireless set value {"text":"Wireless Anvil"}
data modify storage pc:lang lore.repair.wireless set value [["Summon ",{color:"#7abbf1",text:"Anvil"}," (6 ",{color:"#F1DE61",text:"HP"},{color:"white",font:"pc:sys/icon",text:"2"},")."],["It repairs 2 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"}," each turn, last for 3 turns."],["Can active ",{color:"#D983F4",text:"Repair Mode"}," from anywhere."],[],[{color:"gray",text:"ᴏɴ "},{color:"#d983f4",text:"ʀᴇᴘᴀɪʀ ᴍᴏᴅᴇ"},{color:"gray",text:" :"}],["Item won't be ",{color:"#FF6065",text:"disabled"},"."],[],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ ɴᴏ ᴀɴʏ ᴀɴᴠɪʟ ᴇxɪꜱᴛ :"}],["Restore 1 ",{color:"#F1DE61",text:"Durability"},{color:"white",font:"pc:sys/icon",text:"1"},"."]]
...
data modify storage pc:lang lore.skill.warrior/borrowed_time set value [["Gain (",{color:"#F1DE61",text:"Max Energy"},{color:"white","font":"pc:sys/icon","text": "0"},") ",{color:"#F1DE61",text:"Energy"},{color:"white","font":"pc:sys/icon","text": "0"},","],["but lose equivalent amount next turn."],[""],[{color:"gray",text:"ᴇᴠᴇʀʏ ᴛᴜʀɴ :"}],["Restore 1 ",{color:"#F1DE61",text:"Durability"},{color:"white","font":"pc:sys/icon","text":"1"},"."]]

data modify storage pc:lang item.skill.warrior/brittle_assault set value {"text":"Brittle Assault"}
data modify storage pc:lang lore.skill.warrior/brittle_assault set value [["Deal 2 damage. Deal 2 more damage for"],["each ",{color:"#F1DE61",text:"Durability"},{font:"pc:sys/icon",text:"1"}," spent this turn."],[{color:"#72BD7A",text:"●"},{color:"gray",text:" ꜱᴘᴇɴᴛ : "},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]
...
data modify storage pc:lang lore.skill.warrior/fading_compass set value [["Deal 4 damage to all enemies within ",{color:"#7ABBF1",text:"3x3 block"},"."],["Repeat this effect for each ",{color:"#F1DE61",text:"Durability"},{font:"pc:sys/icon",text:"1"},"."],[],[{color:"gray",text:"ᴇɴᴅ ᴏꜰ ʏᴏᴜʀ ᴛᴜʀɴ :"}],["Gain (",{color:"#F1DE61",text:"Durability"},{font:"pc:sys/icon",text:"1"},") ",{color:"#7ABFF1",text:"Shield"},". Consume 1 ",{color:"#F1DE61",text:"Durability"},{font:"pc:sys/icon",text:"1"},"."]]
...
data modify storage pc:lang lore.skill.warrior/heal_liquor set value [["Heal for 50% of ",{color:"#F1DE61",text:"Max HP"},{color:"white","font":"pc:sys/icon","text":"2"}],["and apply 1 ",{color:"#7ABFF1",text:"Misery"},"."],[""],[{color:"gray",text:"ᴏɴ ʟᴏꜱᴇ "},{color:"#F1DE61",text:"ʜᴘ"},{color:"white","font":"pc:sys/icon","text":"2"},{color:"gray",text:" :"}],["For each 1 ",{color:"#F1DE61",text:"HP"},{color:"white","font":"pc:sys/icon","text":"2"}," lost, gain 3 ",{color:"#7ABFF1",text:"Vigor"},"."]]
...
data modify storage pc:lang lore.skill.warrior/momentum set value [["Deal 4 damage. Repeat this effect"],["for each ",{color:"#F1DE61",text:"Energy"},{font:"pc:sys/icon",text:"0"}," spent this turn."],[{color:"#72BD7A",text:"●"},{color:"gray",text:" ʀᴇᴘᴇᴀᴛ : "},{nbt:"item.combat.repeat",storage:"pc:temp",color:"gray"}],[],[{color:"gray",text:"ᴏɴ ꜱᴘᴇɴᴅ 5 "},{color:"#F1DE61",text:"ᴇɴᴇʀɢʏ"},{font:"pc:sys/icon",text:"0"},{color:"gray",text:" :"}],["Gain 1 ",{color:"#F1DE61",text:"Energy"},{font:"pc:sys/icon",text:"0"},"."],[{color:"#72BD7A",text:"●"},{color:"gray",text:" ᴄᴏᴜɴᴛ : "},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]
...
data modify storage pc:lang lore.skill.warrior/engulfed_pain set value [["Apply 3 ",{color:"#7ABBF1",text:"Vulnerable"}," to all enemies within ",{color:"#7ABBF1",text:"3x3 block"},"."],["Can select any block."],[],[{color:"gray",text:"ᴇɴᴅ ᴏꜰ ʏᴏᴜʀ ᴛᴜʀɴ ɪꜰ "},{color:"#F1DE61",text:"ᴅᴜʀᴀʙɪʟɪᴛʏ"},{font:"pc:sys/icon",text:"1"},{color:"gray",text:" ɪꜱ ᴀʙᴏᴠᴇ 0 :"}],["Deal 1 damage to all enemies for"],["each ",{color:"#7abbf1",text:"Vulnerable"}," on them."]]
...
data modify storage pc:lang lore.skill.warrior/repair_jade set value [["Gain (",{color:"#F1DE61",text:"Durability"},{font:"pc:sys/icon",text:"1"},") ",{color:"#7ABBF1",text:"Strength"}," this turn."],["Set ",{color:"#F1DE61",text:"Energy"},{font:"pc:sys/icon",text:"0"}," cost this turn to 1."]]
...
data modify storage pc:lang lore.skill.warrior/yama_double set value [["Release 4 ",{color:"#7ABBF1",text:"Fire Area"}," and evoke all"],[{color:"#7ABBF1",text:"Fire Area"}," that enemies are standing on."],[],[{color:"gray",text:"ꜱᴛᴀʀᴛ ᴏꜰ ᴇᴀᴄʜ ᴛᴜʀɴ :"}],["If any enemy's ",{color:"#F1DE61",text:"HP"},{font:"pc:sys/icon",text:"2"}," is below 25%, they die."]]
