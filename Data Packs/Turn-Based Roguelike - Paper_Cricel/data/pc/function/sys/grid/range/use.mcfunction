...
function pc:sys/grid/range/first with storage pc:temp range
execute positioned ~-1.5 ~-100 ~-1.5 run function pc:sys/grid/range/2
function pc:sys/grid/range/last with storage pc:temp range
