...
# if (target == int) :
execute if function pc:sys/grid/range/facing/is_num/use run return run function pc:sys/grid/range/facing/num with storage pc:temp range.facing
...
function pc:sys/grid/range/facing/entity with storage pc:temp range.facing