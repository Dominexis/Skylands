...
execute if score #is_repairable pc.main matches 1 if function pc:sys/grid/is_entity_repair run return run function pc:sys/grid/update/repair

# elif (in range) :
execute if score #is_in_range pc.main matches 1 run return run function pc:sys/grid/update/in_range
