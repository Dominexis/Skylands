...
function pc:sys/lobby/end/stat/equip {hotbar:"skill[2]",color:"#6FD4A5"}
function pc:sys/lobby/end/stat/equip {hotbar:"skill[3]",color:"#6FD4A5"}
function pc:sys/lobby/end/stat/equip {hotbar:"skill[4]",color:"#6FD4A5"}
function pc:sys/lobby/end/stat/equip {hotbar:"head",color:"#7CBDF2"}
function pc:sys/lobby/end/stat/equip {hotbar:"chest",color:"#7CBDF2"}
function pc:sys/lobby/end/stat/equip {hotbar:"legs",color:"#7CBDF2"}
function pc:sys/lobby/end/stat/equip {hotbar:"feet",color:"#7CBDF2"}
