...
# if (no item) :
$execute unless data storage pc:utils data.entity.hotbar.$(hotbar).id run return run data modify storage pc:utils data.stat.hotbar."$(hotbar)" set value [{text:"[",color:"dark_gray"},{text:"\ue008",font:"pc:sys/space"},{text:"]"}]
...
execute as 20060423-0-0-0-1 run function pc:sys/item/update/name
execute as 20060423-0-0-0-1 run function pc:sys/item/update/lore/use
