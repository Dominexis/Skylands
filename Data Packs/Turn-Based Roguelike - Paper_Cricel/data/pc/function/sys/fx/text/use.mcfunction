...
execute as @e[tag=pc.summon,type=text_display,distance=..20,limit=1] at @s if entity @e[type=minecraft:text_display,distance=..0.1,tag=pc.fx.text,tag=!pc.summon,limit=1] positioned ~ ~0.75 ~ run function pc:sys/fx/text/offset_y
