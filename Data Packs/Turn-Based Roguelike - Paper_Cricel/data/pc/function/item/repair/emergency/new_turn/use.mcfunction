...
# Lore
data modify storage pc:temp desc.lore set value {item:"emergency",index:7,text:[{text:"",italic:0b,color:"gray"},{text:"● ",color:"#72bd7a"},{text:"ᴛᴜʀɴ : "},{score:{name:"#var",objective:"pc.main"}}]}
