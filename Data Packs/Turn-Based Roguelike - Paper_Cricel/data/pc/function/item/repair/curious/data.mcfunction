...
data modify storage pc:temp item.components."minecraft:item_model" set value 'pc:item/repair/curious'
data modify storage pc:temp item.sprite set value {atlas:"gui",sprite:"pc:item/repair/curious"}
