...
execute as @e[type=!minecraft:player,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,tag=pc.damage.skill_cactus,limit=1,predicate=pc:object/mob] at @s run function pc:item/skill/cactus/on_hurt/2
