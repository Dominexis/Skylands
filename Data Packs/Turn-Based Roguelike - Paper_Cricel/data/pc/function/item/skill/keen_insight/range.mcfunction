...
# effect
data modify storage pc:temp range set value {avail:{hole:true}}
...
execute if function pc:sys/grid/detect/mob3x3 as @e[type=marker,tag=pc.grid,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0] run data remove entity @s data.select.in_range