...
data modify storage pc:temp item.id set value 'warrior/yama_double'
...
data modify storage pc:temp item.components."minecraft:item_model" set value 'minecraft:wither_skeleton_spawn_egg'
data modify storage pc:temp item.sprite set value {atlas:"items",sprite:"item/wither_skeleton_spawn_egg"}
