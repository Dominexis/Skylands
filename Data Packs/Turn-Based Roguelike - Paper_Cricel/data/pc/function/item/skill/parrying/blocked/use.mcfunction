...
scoreboard players add @p[predicate=pc:player/ingame,predicate=sl:player,tag=pc.sys.passive,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0] pc.epqueue 1
