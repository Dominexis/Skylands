...
execute as @e[predicate=pc:object/victim,type=!player,limit=1,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0] if data entity @s data.effect.vulnerable run function pc:item/skill/shut_up_of_axe/3
