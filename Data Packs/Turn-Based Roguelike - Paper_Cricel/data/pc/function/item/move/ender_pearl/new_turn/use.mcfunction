...
scoreboard players operation #var pc.main %= #3 sl.value
    ...
    # Lore
data modify storage pc:temp desc.lore set value {item:'ender_pearl', index:6, text:[{text:"",italic: false,color: "gray"},{text:"● ",color:"#72bd7a"},{text:"ᴛᴜʀɴ : "},{score:{name:"#var",objective:"pc.main"}}]}
