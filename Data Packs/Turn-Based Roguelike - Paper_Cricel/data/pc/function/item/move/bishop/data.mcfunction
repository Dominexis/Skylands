...
data modify storage pc:temp item.components."minecraft:item_model" set value 'pc:item/move/bishop'
data modify storage pc:temp item.sprite set value {atlas:"items",sprite:"pc:item/item/move/bishop"}
