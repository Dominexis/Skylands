...
data modify storage pc:temp desc.lore set value {slot:"entity @s armor.chest",index:8,text:[{text:"",italic:0b,color:"gray"},{text:"● ",color:"#72bd7a"},{text:"ᴛɪᴍᴇꜱ : "},{score:{objective:"pc.main",name:"#var"}}]}
