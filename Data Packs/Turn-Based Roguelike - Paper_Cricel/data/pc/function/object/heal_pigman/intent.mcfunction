...
execute store result score #mobs_count pc.main if entity @e[type=!minecraft:player,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,predicate=pc:object/mob]
execute store result score #buddies_count pc.main if entity @e[type=minecraft:zombified_piglin,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,predicate=pc:object/mob,nbt={data:{id:"nether_pigman"}}]
