...
# effect
execute as @e[type=minecraft:zombified_piglin,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,predicate=pc:object/mob,nbt={data:{id:"nether_pigman"}}] at @s run function pc:object/heal_pigman/on_death/2
