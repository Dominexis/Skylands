...
# effect
execute as @e[type=zombified_piglin,predicate=pc:object/mob,nbt={data:{id:'nether_pigman'}},x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0] at @s run function pc:object/heal_pigman/on_death/2
