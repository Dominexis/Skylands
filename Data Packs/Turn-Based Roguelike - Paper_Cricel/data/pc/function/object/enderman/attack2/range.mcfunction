...
data modify storage pc:temp line set value {block:1,mode:any,unhindered:true}
...
data modify storage pc:temp line set value {block:2,mode:any,unhindered:true}
execute at @s run function pc:sys/grid/select/line