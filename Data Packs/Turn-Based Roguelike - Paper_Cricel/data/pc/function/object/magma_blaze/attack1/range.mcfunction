...
data modify storage pc:temp intent set value {damage:30,text:["x3",{"translate":"pc.intent.attack",font:"pc:intent"}],avail:{hole:true}}
data modify storage pc:temp line set value {block:4,mode:'any'}
