...
execute positioned ~-1.5 ~-100 ~-1.5 as @e[type=marker,tag=pc.intent,x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0] if score @s pc.object_id = #self pc.object_id if entity @s[dx=2,dy=200,dz=2] run kill @s