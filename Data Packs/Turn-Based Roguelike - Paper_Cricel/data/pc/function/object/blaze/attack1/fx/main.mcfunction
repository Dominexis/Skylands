...
tp @s ^ ^ ^0.75
execute positioned ~-1.5 ~-100 ~-1.5 if entity @e[predicate=pc:object/ally,type=!player,dx=2,dy=200,dz=2,limit=1] run function pc:object/blaze/attack1/fx/2
...
particle minecraft:block{block_state:"lava"} ~ ~ ~ 0 0 0 1 1 force