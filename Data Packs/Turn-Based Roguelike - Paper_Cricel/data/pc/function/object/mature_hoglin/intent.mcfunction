...
execute if score #temp pc.main matches 75.. run scoreboard players set #mode pc.main 1
execute unless score #temp pc.main matches 75.. run scoreboard players set #mode pc.main 2
