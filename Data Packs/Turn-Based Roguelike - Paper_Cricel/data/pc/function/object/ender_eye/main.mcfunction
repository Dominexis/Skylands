...
execute if score @s pc.fx.float_eye matches 40 run playsound minecraft:entity.ender_dragon.flap master @a[x=2048.0,y=-130.0,z=5120.0,dx=512.0,dy=450.0,dz=512.0,predicate=sl:player] ~ ~ ~ 1 1.25
