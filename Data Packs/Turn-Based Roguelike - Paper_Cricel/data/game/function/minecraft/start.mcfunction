...
execute positioned 2544 2 5542 run function sys:rest_area/campfire/summon
...
execute positioned 2546 1 5558 summon minecraft:villager run function sys:rest_area/trader/summon
...
execute positioned 2534 1 5558 summon minecraft:villager run function sys:rest_area/trader/summon

# Chest loots
function entity:warrior/loot
