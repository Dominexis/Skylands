...
data modify storage pc:game combat.start_button.name set from storage pc:lang game.level.minecraft.nether_fortress
...
data modify storage pc:game combat.grid set value [\
    [{type:"wall"},{type:"wall"},{type:"spac"},{type:"wall"},{type:"spac"}],\
    [{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],\
    [{type:"spac"},{type:"hole"},{type:"spac"},{type:"spac"},{type:"spac"}],\
    [{type:"spac"},{type:"hole"},{type:"spac"},{type:"hole"},{type:"spac"}],\
    [{type:"spac"},{type:"spac"},{type:"spac"},{type:"hole"},{type:"spac"}],\
    [{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],\
    [{type:"spac"},{type:"hole"},{type:"spac"},{type:"wall"},{type:"wall"}]\
]

data modify storage pc:game combat.grid[1][1].lair set value {type:"mob",id:["blaze","blaze_magma"]}
data modify storage pc:game combat.grid[1][2].lair set value {type:"mob",id:["blaze","blaze_magma"]}
data modify storage pc:game combat.grid[1][3].lair set value {type:"mob",id:["blaze","blaze_magma"]}
data modify storage pc:game combat.grid[0][2].lair set value {type:"mob",id:["piglin_heal"]}
