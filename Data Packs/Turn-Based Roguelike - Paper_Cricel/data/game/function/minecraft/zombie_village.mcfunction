...
data modify storage pc:game combat.start_button.name set from storage pc:lang game.level.minecraft.zombie_village
data modify storage pc:game combat.start_button.icon set value 'zombie_villager_spawn_egg'

data modify storage pc:game combat.reward set value {money:"54..63",chest:"rare"}
...
data modify storage pc:game combat.grid set value [\
    [{type:"hole"},{type:"spac"},{type:"spac"},{type:"wall"},{type:"spac"},{type:"spac"},{type:"hole"}],\
    [{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],\
    [{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],\
    [{type:"    "},{type:"hole"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"hole"},{type:"    "}],\
    [{type:"    "},{type:"    "},{type:"spac"},{type:"spac"},{type:"spac"},{type:"hole"},{type:"    "}],\
    [{type:"    "},{type:"    "},{type:"spac"},{type:"spac"},{type:"spac"},{type:"    "},{type:"    "}]\
]
...
data modify storage pc:game combat.grid[2][3].lair set value {type:"mob",id:["iron_golem"]}
