...
data modify storage pc:game combat.start_button.name set from storage pc:lang game.level.minecraft.forest
...
data modify storage pc:game combat.grid set value [\
    ...
    [{type:"wall"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}],\
    [{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"wall"}],\
    [{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"},{type:"spac"}]\
]

data modify storage pc:game combat.grid[0][0].lair set value {type:"mob",id:["zombie","zombie_agile"]}
data modify storage pc:game combat.grid[1][4].lair set value {type:"mob",id:["zombie","zombie_agile"]}
data modify storage pc:game combat.grid[2][1].lair set value {type:"mob",id:["zombie","zombie_agile"]}
