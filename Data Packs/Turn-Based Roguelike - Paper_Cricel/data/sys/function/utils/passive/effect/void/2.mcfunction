...
function sys:utils/passive/effect/void/3 with storage pc:temp passive

data remove storage pc:temp passive.effects.queue[0]
execute if data storage pc:temp passive.effects.queue[0] run return run function sys:utils/passive/effect/void/2