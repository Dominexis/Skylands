...
function sys:utils/passive/effect/return/3 with storage pc:temp passive
...
execute if data storage pc:temp passive.effects.queue[0] run return run function sys:utils/passive/effect/return/2
