...
function sys:utils/passive/effect/return/use
function sys:utils/passive/effect/void/use
...
function sys:utils/passive/entity/2 with storage pc:temp passive.self