...
execute as @e[tag=pc.rest_area.start_button,limit=4] at @s run function sys:void
...
summon minecraft:interaction ~ ~1 ~ {Tags:["pc.rest_area","pc.rest_area.start_button","pc.summon","pc.rest_area.start_button.button"],data:{on_click:"function sys:rest_area/start_button/on_click"}}
...
$function game:$(map_id)/$(level)
schedule function sys:rest_area/start_button/summon/3 1t
