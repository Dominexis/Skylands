...
# if (id == skill_slot) :
execute if data storage pc:temp {purchase:{id:"skill_slot"}} if function sys:rest_area/campfire/update/skill_slot/is_max run return fail

# else :
$function sys:rest_area/campfire/$(id)
