...
data modify storage pc:lang sys.lore.option.campfire.hpmax set value {"text": "","italic": false,"color": "white","extra": ["增加 3 點",{"text": "最大血量","color": "#F1DE61"},{"font":"sys:icon","text":"2","color": "white"},"。"]}
data modify storage pc:lang sys.item.option.campfire.epmax set value {"text": "能量提升"}
data modify storage pc:lang sys.lore.option.campfire.epmax set value {"text": "","italic": false,"color": "white","extra": ["增加 1 點",{"text": "最大能量","color": "#F1DE61"},{"font":"sys:icon","text":"0","color": "white"},"。"]}
...
data modify storage pc:lang sys.lobby.author.twitter set value [{text:" ",color:"gray",type:"text"},{text:"● ",color:"#72BD7A",type:"text"},{text:"\uf002 ","font":"sys:icon",shadow_color:0,color:"white",type:"text"},{text:"Twitter : ",type:"text"},{text:"@CricelPaper",click_event:{action:"open_url",url:"https://x.com/CricelPaper"},underlined:1b,hover_event:{action:"show_text",value:[{text:"點我開啟連結！",type:"text"}]},type:"text"}]
...
data modify storage pc:lang sys.lobby.settings.ascension.tough_enemies.desc set value ["所有敵人增加 10% ",{text:"血量",color:"#F1DE61"},{text:"2",font:"sys:icon"},"。"]
data modify storage pc:lang sys.lobby.settings.ascension.poor_elites.desc set value ["精英掉落的",{text:"金錢",color:"#F1DE61"},{text:"3",font:"sys:icon"},"減少 25%。"]
...
data modify storage pc:lang sys.lobby.settings.ascension.tough_enemies.label set value [{text:"",font:"sys:modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.tough_enemies.desc",storage:"pc:lang",interpret:1b}}},{text:" 強韌敵人：",font:"minecraft:default"}]
data modify storage pc:lang sys.lobby.settings.ascension.poor_elites.label set value [{text:"",font:"sys:modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.poor_elites.desc",storage:"pc:lang",interpret:1b}}},{text:" 貧窮精英：",font:"minecraft:default"}]
data modify storage pc:lang sys.lobby.settings.ascension.lost_slots.label set value [{text:"",font:"sys:modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.lost_slots.desc",storage:"pc:lang",interpret:1b}}},{text:" 欄位缺失：",font:"minecraft:default"}]
...
data modify storage pc:lang sys.lobby.end.hp set value [{color:"gray",text:" 血量"},{"font":"sys:icon","text":"2",type:"text",color:"white"}]
data modify storage pc:lang sys.lobby.end.energy set value [{color:"gray",text:" 能量"},{"font":"sys:icon","text":"0",type:"text",color:"white"}]
...
data modify storage pc:lang lore.chest.repair_core set value [[{color:"gray",text:"每有一個處於"},{color:"#d983f4",text:"修復模式"},{color:"gray",text:"的鐵砧："}],["本回合獲得 2 點",{color:"#7ABFF1",text:"力量"},"。"],[],[{color:"gray",text:"每次戰鬥開始時："}],["增加所有",{color:"#D983F4",text:"技能物品"}," 1 點",{color:"#F1DE61",text:"最大耐久度"},{"font":"sys:icon","text":"1"},"。"]]

data modify storage pc:lang item.feet.energy_surge set value {"text":"能量湧動"}
data modify storage pc:lang lore.feet.energy_surge set value [[{color:"gray",text:"每當消耗任何物品的"},{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},{color:"gray",text:"時："}],["對所有 ",{color:"#7ABBF1",text:"3x3格 "},"內的敵人造成"],["同等 (",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},") 點傷害。"],[],[{color:"gray",text:"使用"},{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},{color:"gray",text:"消耗大於等於 2 的物品時："}],["此物品",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"不會被消耗。"],["每回合只能觸發一次。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 本回合："},{nbt:"item.combat.this_turn",storage:"pc:temp",interpret:1b}]]

data modify storage pc:lang item.feet.footwork set value {"text":"靈動步法"}
data modify storage pc:lang lore.feet.footwork set value [[{color:"gray",text:"每回合使用的第 4 個物品："}],[{color:"#f1de61",text:"耐久度"},{"font":"sys:icon","text":"1"},"不會被消耗。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 次數：",extra:[{nbt:"item.combat.times",storage:"pc:temp"}]}],[],[{color:"gray",text:"每次戰鬥開始時："}],["增加",{color:"#D983F4",text:"移動物品"}," 2 點",{color:"#f1de61",text:"最大耐久度"},{"font":"sys:icon","text":"1"},"。"]]

data modify storage pc:lang item.feet.vigilance set value {"text":"警戒"}
data modify storage pc:lang lore.feet.vigilance set value [[{color:"gray",text:"每回合開始時："}],["本回合每有一位在 ",{color:"#7ABBF1",text:"9格十字 "},"範圍內的敵人，"],["就增加",{color:"#D983F4",text:"移動物品"}," 1 點",{color:"#F1DE61",text:"最大耐久度"},{font:"sys:icon",text:"1"},"。"],[],[{color:"gray",text:"每回合結束時："}],["將",{color:"#D983F4",text:"移動物品"},"的每點",{color:"#f1de61",text:"耐久度"},{font:"sys:icon",text:"1"},"轉換為 3 點",{color:"#7ABBF1",text:"活力"},"。"]]

data modify storage pc:lang item.head.frenzied set value {"text":"狂暴"}
data modify storage pc:lang lore.head.frenzied set value [[{color:"gray",text:"每第 4 次攻擊："}],["攻擊傷害翻倍。"],["獲得 1 點",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"。"],[{color:"#72BD7A",text:"● "},{color:"gray",text:"次數："},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]

data modify storage pc:lang item.head.gold_greed set value {"text":"貪財"}
data modify storage pc:lang lore.head.gold_greed set value [[{color:"gray",text:"戰鬥結束時："}],["獲得額外 50% 的",{color:"#F1DE61",text:"金錢"},{font:"sys:icon",text:"3"},"。"],[],[{color:"gray",text:"擊殺時："}],["如果敵人不是",{color:"#7ABBF1",text:"爪牙"},"，獲得 3 ",{color:"#F1DE61",text:"金錢"},{font:"sys:icon",text:"3"},"。"]]

data modify storage pc:lang item.head.min_passion set value {"text":"三分鐘熱度"}
data modify storage pc:lang lore.head.min_passion set value [[{color:"gray",text:"每次戰鬥開始時："}],["獲得 3 點",{color:"#7ABFF1",text:"力量"},"。獲得 3 點",{color:"#F1DE61",text:"能量"},{"font":"sys:icon","text": "0"},"。"],[],[{color:"gray",text:"如果 3 回合內沒有任何人死亡："}],["失去 1 點",{color:"#7ABFF1",text:"力量"},"。失去 1 點",{color:"#F1DE61",text:"能量"},{"font":"sys:icon","text": "0"},"。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 回合：",extra:[{nbt:"item.combat.turn",storage:"pc:temp"}]}]]

data modify storage pc:lang item.legs.iron_resolve set value {"text":"鋼鐵意志"}
data modify storage pc:lang lore.legs.iron_resolve set value [[{color:"gray",text:"如果"},{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},{color:"gray",text:"低於 50%："}],["造成的傷害增加 50%。"],["在回合開始時，回復 1 點",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},"。"],[],[{color:"gray",text:"在你第 1 次死亡時："}],["將",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},"設為 1。"],["此物品會在戰鬥結束時被摧毀。"]]

data modify storage pc:lang item.legs.jerk_reflex set value {"text":"膝跳反射"}
data modify storage pc:lang lore.legs.jerk_reflex set value [[{color:"gray",text:"回合開始時："}],["上一回合你每受到攻擊"],["1 次，獲得 2 點",{color:"#7ABFF1",text:"護盾"},"。"],[],[{color:"gray",text:"失去"},{color:"#f1de61",text:"血量"},{font:"sys:icon",text:"2"},{color:"gray",text:"時："}],["少失去 1 點。"]]

data modify storage pc:lang item.legs.residual_defense set value {"text":"殘存護甲"}
data modify storage pc:lang lore.legs.residual_defense set value [[{color:"gray",text:"回合結束時："}],["將剩餘的每點",{color:"#f1de61",text:"能量"},{"font":"sys:icon","text": "0"},"轉換為 3 點",{color:"#7ABFF1",text:"護盾"},"。"],["如果",{color:"#f1de61",text:"能量"},{"font":"sys:icon","text": "0"},"大於等於 4，",{color:"#7abbf1",text:"護盾"},"不會在"],["你的下回合開始時被移除。"]]

# Items

    # Move
data modify storage pc:lang item.move.basic set value {"text":"移動"}
data modify storage pc:lang lore.move.basic set value [["移動 1 格。"],[],[{color:"gray",text:"每回合："}],["恢復所有",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.move.bishop set value {"text":"主教"}
data modify storage pc:lang lore.move.bishop set value [["移動 1 格。"],["可選擇 ",{color:"#7ABBF1",text:"3x3格"}," 內的範圍。"],[],[{color:"gray",text:"所有"},{color:"#D983F4",text:"技能物品"},{color:"gray",text:"："}],["可額外選擇斜向 ",{color:"#7ABBF1",text:"1格十字"}," 內的範圍。"],[],[{color:"gray",text:"每回合："}],["恢復所有",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.move.ender_pearl set value {"text":"終界珍珠"}
data modify storage pc:lang lore.move.ender_pearl set value [["移動 1 格。可選擇 ",{color:"#7ABBF1",text:"7x7格 "},"內的範圍。"],["如果沒有",{color:"#7abbf1",text:"幻影"},"存在，失去 1 點",{color:"#f1de61",text:"血量"},{font:"sys:icon",text:"2"}],["並在原來的位置召喚",{color:"#7abbf1",text:"幻影"}," (1 點",{color:"#f1de61",text:"血量"},{font:"sys:icon",text:"2"},")。"],[],[{color:"gray",text:"每回合："}],["恢復所有",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.move.jump set value {"text":"跳躍"}
data modify storage pc:lang lore.move.jump set value [["移動最多 2 格，無視被佔用的方塊。"],[],[{color:"gray",text:"每回合第 1 次使用"},{color:"#d983f4",text:"移動物品"},{color:"gray",text:"時："}],["獲得 1 層",{color:"#7ABFF1",text:"爆擊"},"。"],[],[{color:"gray",text:"每回合："}],["恢復所有",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.move.minecart set value {"text":"礦車"}
data modify storage pc:lang lore.move.minecart set value [["移動 1 格或移動到",{color:"#7abbf1",text:"鐵軌區域"},"方塊。"],["在當前方塊釋放",{color:"#7abbf1",text:"鐵軌區域"},"。"],[],[{color:"gray",text:"如果選擇的方塊上有任何人："}],["造成 4 點傷害。給予 1 層",{color:"#7abbf1",text:"虛弱"},"。",{color:"#7abbf1",text:"擊退"},"。"],[],[{color:"gray",text:"每回合："}],["恢復所有",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

    # Repair
data modify storage pc:lang item.repair.basic set value {"text":"鐵砧"}
data modify storage pc:lang lore.repair.basic set value [["召喚",{color:"#7abbf1",text:"鐵砧"}," (6 點",{color:"#F1DE61",text:"血量"},{color:"white",font:"sys:icon",text:"2"},")。"],["需要 2 回合來修復 3 點",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"],[],[{color:"gray",text:"每回合："}],["恢復 1 點",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.repair.magma set value {"text":"熔岩鐵砧"}
data modify storage pc:lang lore.repair.magma set value [["召喚",{color:"#7abbf1",text:"鐵砧"}," (12 點",{color:"#F1DE61",text:"血量"},{color:"white",font:"sys:icon",text:"2"},")。"],["需要 2 回合來修復 3 點",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"],["它免疫",{color:"#7abbf1",text:"火焰區域"},"傷害。"],[],[{color:"gray",text:"當鐵砧死亡時："}],["它會在 ",{color:"#7ABBF1",text:"1格十字 "},"範圍內釋放 4 層",{color:"#7abbf1",text:"火焰區域"},"。"],[],[{color:"gray",text:"每回合："}],["恢復 1 點",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.repair.rugged set value {"text":"強壯鐵砧"}
data modify storage pc:lang lore.repair.rugged set value [["召喚",{color:"#7abbf1",text:"鐵砧"}," (18 點",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},")。"],["需要 3 回合來修復所有",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"],["每回合，它會給予所有位於 ",{color:"#7ABBF1",text:"3x3格 "}],["內的友軍 3 點",{color:"#7ABBF1",text:"護盾"},"。"],[],[{color:"gray",text:"當鐵砧完成修復時："}],["獲得 2 點",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"。"],[],[{color:"gray",text:"每回合："}],["恢復 1 點",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.repair.curious set value {"text":"好奇鐵砧"}
data modify storage pc:lang lore.repair.curious set value [["召喚",{color:"#7abbf1",text:"鐵砧"}," (",{nbt:"item.combat.hpmax",storage:"pc:temp"}," 點",{color:"#F1DE61",text:"血量"},{color:"white",font:"sys:icon",text:"2"},")。"],["需要 2 回合來修復 3 點",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"],[{italic:false,color:"white",text:""}],[{color:"gray",text:"當鐵砧完成修復時："}],["如果 ",{color:"#7ABBF1",text:"1格十字 "},"範圍內有敵人，"],["修復者獲得 2 點",{color:"#7ABBF1",text:"力量"},"。"],[{italic:false,color:"white",text:""}],[{color:"gray",text:"當鐵砧被任何人摧毀時："}],["召喚出的",{color:"#7abbf1",text:"鐵砧"},"增加 2 點",{color:"#F1DE61",text:"最大血量"},{font:"sys:icon",text:"2"},"，"],["修復者下回合獲得 1 點",{color:"#F1DE61",text:"能量"},{color:"white",font:"sys:icon",text:"0"},"。"],[{italic:false,color:"white",text:""}],[{color:"gray",text:"每回合："}],["恢復 1 點",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.repair.wireless set value {"text":"無線鐵砧"}
data modify storage pc:lang lore.repair.wireless set value [["召喚",{color:"#7abbf1",text:"鐵砧"}," (6 點",{color:"#F1DE61",text:"血量"},{color:"white",font:"sys:icon",text:"2"},")。"],["每回合修復 2 點",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"，持續 3 回合。"],["可以從任何地方啟動",{color:"#D983F4",text:"修復模式"},"。"],[],[{color:"gray",text:"處於"},{color:"#d983f4",text:"修復模式"},{color:"gray",text:"時："}],["物品不會被",{color:"#FF6065",text:"禁用"},"。"],[],[{color:"gray",text:"每回合若沒有任何鐵砧存在："}],["恢復 1 點",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]
...
data modify storage pc:lang lore.skill.warrior/borrowed_time set value [["獲得等同 (",{color:"#F1DE61",text:"最大能量"},{color:"white","font":"sys:icon","text": "0"},") 的",{color:"#F1DE61",text:"能量"},{color:"white","font":"sys:icon","text": "0"},"，"],["但下回合會失去等量的能量。"],[""],[{color:"gray",text:"每回合："}],["恢復 1 點",{color:"#F1DE61",text:"耐久度"},{color:"white","font":"sys:icon","text":"1"},"。"]]

data modify storage pc:lang item.skill.warrior/brittle_assault set value {"text":"脆弱猛擊"}
data modify storage pc:lang lore.skill.warrior/brittle_assault set value [["造成 2 點傷害。本回合每消耗 1 點"],[{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"，就額外增加 2 點傷害。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 消耗量："},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]
...
data modify storage pc:lang lore.skill.warrior/fading_compass set value [["對 ",{color:"#7ABBF1",text:"3x3格 "},"內的所有敵人造成 4 點傷害。"],["每有 1 點",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"就重複此效果 1 次。"],[],[{color:"gray",text:"回合結束時："}],["獲得等同 (",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},") 的",{color:"#7ABFF1",text:"護盾"},"。"],["消耗 1 點",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"]]
...
data modify storage pc:lang lore.skill.warrior/heal_liquor set value [["回復 50% 的",{color:"#F1DE61",text:"最大血量"},{font:"sys:icon",text:"2"}],["並給予 1 層",{color:"#7ABFF1",text:"苦痛"},"。"],[],[{color:"gray",text:"失去"},{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},{color:"gray",text:"時："}],["每失去 1 點",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},"，就獲得 3 點",{color:"#7ABFF1",text:"活力"},"。"]]
...
data modify storage pc:lang lore.skill.warrior/momentum set value [["造成 4 點傷害。本回合每消耗"],["1 點",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"就重複此效果 1 次。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 重複："},{nbt:"item.combat.repeat",storage:"pc:temp",color:"gray"}],[],[{color:"gray",text:"當消耗 5 點"},{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},{color:"gray",text:"時："}],["獲得 1 點",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 次數："},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]
...
data modify storage pc:lang lore.skill.warrior/parrying set value [["獲得 7 點",{color:"#7ABFF1",text:"護盾"},"。本回合",{color:"#ff6065",text:"禁用"},{color:"#D983F4",text:"移動物品"},"。"],[],[{color:"gray",text:"受傷時："}],[{color:"#7ABFF1",text:"擊退"},"攻擊者。如果成功格擋，恢復 1 點"],[{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"並在下回合獲得 1 點",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"。"]]
...
data modify storage pc:lang lore.skill.warrior/engulfed_pain set value [["給予 ",{color:"#7ABBF1",text:"3x3格 "},"內的所有敵人 3 層",{color:"#7ABBF1",text:"易傷"},"。"],["可以選擇任何方塊。"],[],[{color:"gray",text:"回合結束時，如果"},{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},{color:"gray",text:"大於 0："}],["所有敵人身上每有 1 層",{color:"#7abbf1",text:"易傷"},"，"],["就對他們造成 1 點傷害。"]]
...
data modify storage pc:lang lore.skill.warrior/repair_jade set value [["本回合獲得等同 (",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},") 點",{color:"#7ABBF1",text:"力量"},"。"],["將本回合的",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"消耗設為 1。"]]
...
data modify storage pc:lang lore.skill.warrior/yama_double set value [["釋放 4 層",{color:"#7ABBF1",text:"火焰區域"},"並立即觸發"],["敵人位置上的所有",{color:"#7ABBF1",text:"火焰區域"},"。"],[],[{color:"gray",text:"每回合開始時："}],["如果任何敵人的",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},"低於 25%，"],["他們將直接死亡。"]]
