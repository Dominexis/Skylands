...
data modify storage pc:lang sys.lore.option.campfire.hpmax set value {"text": "","italic": false,"color": "white","extra": ["增加 3 点",{"text": "最大血量","color": "#F1DE61"},{"font":"sys:icon","text":"2","color": "white"},"。"]}
data modify storage pc:lang sys.item.option.campfire.epmax set value {"text": "能量提升"}
data modify storage pc:lang sys.lore.option.campfire.epmax set value {"text": "","italic": false,"color": "white","extra": ["增加 1 点",{"text": "最大能量","color": "#F1DE61"},{"font":"sys:icon","text":"0","color": "white"},"。"]}
...
data modify storage pc:lang sys.lobby.author.twitter set value [{text:" ",color:"gray",type:"text"},{text:"● ",color:"#72BD7A",type:"text"},{text:"\uf002 ","font":"sys:icon",shadow_color:0,color:"white",type:"text"},{text:"Twitter : ",type:"text"},{text:"@CricelPaper",click_event:{action:"open_url",url:"https://x.com/CricelPaper"},underlined:1b,hover_event:{action:"show_text",value:[{text:"点我开启链接！",type:"text"}]},type:"text"}]
...
data modify storage pc:lang sys.lobby.settings.ascension.tough_enemies.desc set value ["所有敌人增加 10% ",{text:"血量",color:"#F1DE61"},{text:"2",font:"sys:icon"},"。"]
data modify storage pc:lang sys.lobby.settings.ascension.poor_elites.desc set value ["精英掉落的",{text:"金钱",color:"#F1DE61"},{text:"3",font:"sys:icon"},"减少 25%。"]
...
data modify storage pc:lang sys.lobby.settings.ascension.tough_enemies.label set value [{text:"",font:"sys:modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.tough_enemies.desc",storage:"pc:lang",interpret:1b}}},{text:" 强韧敌人：",font:"minecraft:default"}]
data modify storage pc:lang sys.lobby.settings.ascension.poor_elites.label set value [{text:"",font:"sys:modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.poor_elites.desc",storage:"pc:lang",interpret:1b}}},{text:" 贫穷精英：",font:"minecraft:default"}]
data modify storage pc:lang sys.lobby.settings.ascension.lost_slots.label set value [{text:"",font:"sys:modifier",hover_event:{action:"show_text",value:{nbt:"sys.lobby.settings.ascension.lost_slots.desc",storage:"pc:lang",interpret:1b}}},{text:" 栏位缺失：",font:"minecraft:default"}]
...
data modify storage pc:lang lore.chest.repair_core set value [[{color:"gray",text:"每有一个处于"},{color:"#d983f4",text:"修复模式"},{color:"gray",text:"的铁砧："}],["本回合获得 2 点",{color:"#7ABFF1",text:"力量"},"。"],[],[{color:"gray",text:"每次战斗开始时："}],["增加所有",{color:"#D983F4",text:"技能物品"}," 1 点",{color:"#F1DE61",text:"最大耐久度"},{"font":"sys:icon","text":"1"},"。"]]

data modify storage pc:lang item.feet.energy_surge set value {"text":"能量涌动"}
data modify storage pc:lang lore.feet.energy_surge set value [[{color:"gray",text:"每当消耗任何物品的"},{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},{color:"gray",text:"时："}],["对所有 ",{color:"#7ABBF1",text:"3x3格 "},"内的敌人造成"],["同等 (",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},") 点伤害。"],[],[{color:"gray",text:"使用"},{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},{color:"gray",text:"消耗大于等于 2 的物品时："}],["此物品",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"不会被消耗。"],["每回合只能触发一次。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 本回合："},{nbt:"item.combat.this_turn",storage:"pc:temp",interpret:1b}]]

data modify storage pc:lang item.feet.footwork set value {"text":"灵动步法"}
data modify storage pc:lang lore.feet.footwork set value [[{color:"gray",text:"每回合使用的第 4 个物品："}],[{color:"#f1de61",text:"耐久度"},{"font":"sys:icon","text":"1"},"不会被消耗。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 次数：",extra:[{nbt:"item.combat.times",storage:"pc:temp"}]}],[],[{color:"gray",text:"每次战斗开始时："}],["增加",{color:"#D983F4",text:"移动物品"}," 2 点",{color:"#f1de61",text:"最大耐久度"},{"font":"sys:icon","text":"1"},"。"]]

data modify storage pc:lang item.feet.vigilance set value {"text":"警戒"}
data modify storage pc:lang lore.feet.vigilance set value [[{color:"gray",text:"每回合开始时："}],["本回合每有一位在 ",{color:"#7ABBF1",text:"9格十字 "},"范围内的敌人，"],["就增加",{color:"#D983F4",text:"移动物品"}," 1 点",{color:"#F1DE61",text:"最大耐久度"},{font:"sys:icon",text:"1"},"。"],[],[{color:"gray",text:"每回合结束时："}],["将",{color:"#D983F4",text:"移动物品"},"的每点",{color:"#f1de61",text:"耐久度"},{font:"sys:icon",text:"1"},"转换为 3 点",{color:"#7ABBF1",text:"活力"},"。"]]

data modify storage pc:lang item.head.frenzied set value {"text":"狂暴"}
data modify storage pc:lang lore.head.frenzied set value [[{color:"gray",text:"每第 4 次攻击："}],["攻击伤害翻倍。"],["获得 1 点",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"。"],[{color:"#72BD7A",text:"● "},{color:"gray",text:"次数："},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]

data modify storage pc:lang item.head.gold_greed set value {"text":"贪财"}
data modify storage pc:lang lore.head.gold_greed set value [[{color:"gray",text:"战斗结束时："}],["获得额外 50% 的",{color:"#F1DE61",text:"金钱"},{font:"sys:icon",text:"3"},"。"],[],[{color:"gray",text:"击杀时："}],["如果敌人不是",{color:"#7ABBF1",text:"爪牙"},"，获得 3 ",{color:"#F1DE61",text:"金钱"},{font:"sys:icon",text:"3"},"。"]]

data modify storage pc:lang item.head.min_passion set value {"text":"三分钟热度"}
data modify storage pc:lang lore.head.min_passion set value [[{color:"gray",text:"每次战斗开始时："}],["获得 3 点",{color:"#7ABFF1",text:"力量"},"。获得 3 点",{color:"#F1DE61",text:"能量"},{"font":"sys:icon","text": "0"},"。"],[],[{color:"gray",text:"如果 3 回合内没有任何人死亡："}],["失去 1 点",{color:"#7ABFF1",text:"力量"},"。失去 1 点",{color:"#F1DE61",text:"能量"},{"font":"sys:icon","text": "0"},"。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 回合：",extra:[{nbt:"item.combat.turn",storage:"pc:temp"}]}]]

data modify storage pc:lang item.legs.iron_resolve set value {"text":"钢铁意志"}
data modify storage pc:lang lore.legs.iron_resolve set value [[{color:"gray",text:"如果"},{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},{color:"gray",text:"低于 50%："}],["造成的伤害增加 50%。"],["在回合开始时，回复 1 点",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},"。"],[],[{color:"gray",text:"在你第 1 次死亡时："}],["将",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},"设为 1。"],["此物品会在战斗结束时被摧毁。"]]

data modify storage pc:lang item.legs.jerk_reflex set value {"text":"膝跳反射"}
data modify storage pc:lang lore.legs.jerk_reflex set value [[{color:"gray",text:"回合开始时："}],["上一回合你每受到攻击"],["1 次，获得 2 点",{color:"#7ABBF1",text:"护盾"},"。"],[],[{color:"gray",text:"失去"},{color:"#f1de61",text:"血量"},{font:"sys:icon",text:"2"},{color:"gray",text:"时："}],["少失去 1 点。"]]

data modify storage pc:lang item.legs.residual_defense set value {"text":"残存护甲"}
data modify storage pc:lang lore.legs.residual_defense set value [[{color:"gray",text:"回合结束时："}],["将剩余的每点",{color:"#f1de61",text:"能量"},{"font":"sys:icon","text": "0"},"转换为 3 点",{color:"#7ABBF1",text:"护盾"},"。"],["如果",{color:"#f1de61",text:"能量"},{"font":"sys:icon","text": "0"},"大于等于 4，",{color:"#7abbf1",text:"护盾"},"不会在"],["你的下回合开始时被移除。"]]

# Items

    # Move
data modify storage pc:lang item.move.basic set value {"text":"移动"}
data modify storage pc:lang lore.move.basic set value [["移动 1 格。"],[],[{color:"gray",text:"每回合："}],["恢复所有",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.move.bishop set value {"text":"主教"}
data modify storage pc:lang lore.move.bishop set value [["移动 1 格。"],["可选择 ",{color:"#7ABBF1",text:"3x3格"}," 内的范围。"],[],[{color:"gray",text:"所有"},{color:"#D983F4",text:"技能物品"},{color:"gray",text:"："}],["可额外选择斜向 ",{color:"#7ABBF1",text:"1格十字"}," 内的范围。"],[],[{color:"gray",text:"每回合："}],["恢复所有",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.move.ender_pearl set value {"text":"末影珍珠"}
data modify storage pc:lang lore.move.ender_pearl set value [["移动 1 格。可选择 ",{color:"#7ABBF1",text:"7x7格 "},"内的范围。"],["如果没有",{color:"#7abbf1",text:"幻影"},"存在，失去 1 点",{color:"#f1de61",text:"血量"},{font:"sys:icon",text:"2"}],["并在原来的位置召唤",{color:"#7abbf1",text:"幻影"}," (1 点",{color:"#f1de61",text:"血量"},{font:"sys:icon",text:"2"},")。"],[],[{color:"gray",text:"每回合："}],["恢复所有",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.move.jump set value {"text":"跳跃"}
data modify storage pc:lang lore.move.jump set value [["移动最多 2 格，忽视被占用的方块。"],[],[{color:"gray",text:"每回合第 1 次使用"},{color:"#d983f4",text:"移动物品"},{color:"gray",text:"时："}],["获得 1 层",{color:"#7ABFF1",text:"暴击"},"。"],[],[{color:"gray",text:"每回合："}],["恢复所有",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.move.minecart set value {"text":"矿车"}
data modify storage pc:lang lore.move.minecart set value [["移动 1 格或移动到",{color:"#7abbf1",text:"铁轨区域"},"方块。"],["在当前方块释放",{color:"#7abbf1",text:"铁轨区域"},"。"],[],[{color:"gray",text:"如果选择的方块上有任何人："}],["造成 4 点伤害。给予 1 层",{color:"#7abbf1",text:"虚弱"},"。",{color:"#7abbf1",text:"击退"},"。"],[],[{color:"gray",text:"每回合："}],["恢复所有",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

    # Repair
data modify storage pc:lang item.repair.basic set value {"text":"铁砧"}
data modify storage pc:lang lore.repair.basic set value [["召唤",{color:"#7abbf1",text:"铁砧"}," (6 点",{color:"#F1DE61",text:"血量"},{color:"white",font:"sys:icon",text:"2"},")。"],["需要 2 回合来修复 3 点",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"],[],[{color:"gray",text:"每回合："}],["恢复 1 点",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.repair.magma set value {"text":"熔岩铁砧"}
data modify storage pc:lang lore.repair.magma set value [["召唤",{color:"#7abbf1",text:"铁砧"}," (12 点",{color:"#F1DE61",text:"血量"},{color:"white",font:"sys:icon",text:"2"},")。"],["需要 2 回合来修复 3 点",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"],["它免疫",{color:"#7abbf1",text:"火焰区域"},"伤害。"],[],[{color:"gray",text:"当铁砧死亡时："}],["它会在 ",{color:"#7ABBF1",text:"1格十字 "},"范围内释放 4 层",{color:"#7abbf1",text:"火焰区域"},"。"],[],[{color:"gray",text:"每回合："}],["恢复 1 点",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.repair.rugged set value {"text":"强壮铁砧"}
data modify storage pc:lang lore.repair.rugged set value [["召唤",{color:"#7abbf1",text:"铁砧"}," (18 点",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},")。"],["需要 3 回合来修复所有",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"],["每回合，它会给予所有位于 ",{color:"#7ABBF1",text:"3x3格 "}],["内的友军 3 点",{color:"#7ABBF1",text:"护盾"},"。"],[],[{color:"gray",text:"当铁砧完成修复时："}],["获得 2 点",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"。"],[],[{color:"gray",text:"每回合："}],["恢复 1 点",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.repair.curious set value {"text":"好奇铁砧"}
data modify storage pc:lang lore.repair.curious set value [["召唤",{color:"#7abbf1",text:"铁砧"}," (",{nbt:"item.combat.hpmax",storage:"pc:temp"}," 点",{color:"#F1DE61",text:"血量"},{color:"white",font:"sys:icon",text:"2"},")。"],["需要 2 回合来修复 3 点",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"],[{italic:false,color:"white",text:""}],[{color:"gray",text:"当铁砧完成修复时："}],["如果 ",{color:"#7ABBF1",text:"1格十字 "},"范围内有敌人，"],["修复者获得 2 点",{color:"#7ABBF1",text:"力量"},"。"],[{italic:false,color:"white",text:""}],[{color:"gray",text:"当铁砧被任何人摧毁时："}],["召唤出的",{color:"#7abbf1",text:"铁砧"},"增加 2 点",{color:"#F1DE61",text:"最大血量"},{font:"sys:icon",text:"2"},"，"],["修复者下回合获得 1 点",{color:"#F1DE61",text:"能量"},{color:"white",font:"sys:icon",text:"0"},"。"],[{italic:false,color:"white",text:""}],[{color:"gray",text:"每回合："}],["恢复 1 点",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]

data modify storage pc:lang item.repair.wireless set value {"text":"无线铁砧"}
data modify storage pc:lang lore.repair.wireless set value [["召唤",{color:"#7abbf1",text:"铁砧"}," (6 点",{color:"#F1DE61",text:"血量"},{color:"white",font:"sys:icon",text:"2"},")。"],["每回合修复 2 点",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"，持续 3 回合。"],["可以从任何地方启动",{color:"#D983F4",text:"修复模式"},"。"],[],[{color:"gray",text:"处于结构"},{color:"#d983f4",text:"修复模式"},{color:"gray",text:"时："}],["物品不会被",{color:"#FF6065",text:"禁用"},"。"],[],[{color:"gray",text:"每回合若没有任何铁砧存在："}],["恢复 1 点",{color:"#F1DE61",text:"耐久度"},{color:"white",font:"sys:icon",text:"1"},"。"]]
...
data modify storage pc:lang lore.skill.warrior/borrowed_time set value [["获得等同 (",{color:"#F1DE61",text:"最大能量"},{color:"white","font":"sys:icon","text": "0"},") 的",{color:"#F1DE61",text:"能量"},{color:"white","font":"sys:icon","text": "0"},"，"],["但下回合会失去等量的能量。"],[""],[{color:"gray",text:"每回合："}],["恢复 1 点",{color:"#F1DE61",text:"耐久度"},{color:"white","font":"sys:icon","text":"1"},"。"]]

data modify storage pc:lang item.skill.warrior/brittle_assault set value {"text":"脆弱猛击"}
data modify storage pc:lang lore.skill.warrior/brittle_assault set value [["造成 2 点伤害。本回合每消耗 1 点"],[{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"，就额外增加 2 点伤害。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 消耗量："},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]
...
data modify storage pc:lang lore.skill.warrior/fading_compass set value [["对 ",{color:"#7ABBF1",text:"3x3格 "},"内的所有敌人造成 4 点伤害。"],["每有 1 点",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"就重复此效果 1 次。"],[],[{color:"gray",text:"回合结束时："}],["获得等同 (",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},") 的",{color:"#7ABBF1",text:"护盾"},"。"],["消耗 1 点",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"。"]]
...
data modify storage pc:lang lore.skill.warrior/heal_liquor set value [["回复 50% 的",{color:"#F1DE61",text:"最大血量"},{color:"white","font":"sys:icon","text":"2"}],["并给予 1 层",{color:"#7ABFF1",text:"苦痛"},"。"],[""],[{color:"gray",text:"失去"},{color:"#F1DE61",text:"血量"},{color:"white","font":"sys:icon","text":"2"},{color:"gray",text:"时："}],["每失去 1 点",{color:"#F1DE61",text:"血量"},{color:"white","font":"sys:icon","text":"2"},"，就获得 3 点",{color:"#7ABFF1",text:"活力"},"。"]]
...
data modify storage pc:lang lore.skill.warrior/momentum set value [["造成 4 点伤害。本回合每消耗"],["1 点",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"就重复此效果 1 次。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 重复："},{nbt:"item.combat.repeat",storage:"pc:temp",color:"gray"}],[],[{color:"gray",text:"当消耗 5 点"},{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},{color:"gray",text:"时："}],["获得 1 点",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"。"],[{color:"#72BD7A",text:"●"},{color:"gray",text:" 次数："},{nbt:"item.combat.count",storage:"pc:temp",color:"gray"}]]
...
data modify storage pc:lang lore.skill.warrior/parrying set value [["获得 7 點",{color:"#7ABBF1",text:"护盾"},"。本回合",{color:"#ff6065",text:"禁用"},{color:"#D983F4",text:"移动物品"},"。"],[],[{color:"gray",text:"受伤时："}],[{color:"#7ABFF1",text:"击退"},"攻击者。如果成功格挡，恢复 1 点"],[{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},"并在下回合获得 1 点",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"。"]]
...
data modify storage pc:lang lore.skill.warrior/engulfed_pain set value [["给予 ",{color:"#7ABBF1",text:"3x3格 "},"内的所有敌人 3 层",{color:"#7ABBF1",text:"易伤"},"。"],["可以选择任何方块。"],[],[{color:"gray",text:"回合结束时，如果"},{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},{color:"gray",text:"大于 0："}],["所有敌人身上每有 1 层",{color:"#7abbf1",text:"易伤"},"，"],["就对他们造成 1 点伤害。"]]
...
data modify storage pc:lang lore.skill.warrior/repair_jade set value [["本回合获得等同 (",{color:"#F1DE61",text:"耐久度"},{font:"sys:icon",text:"1"},") 点",{color:"#7ABBF1",text:"力量"},"。"],["将本回合的",{color:"#F1DE61",text:"能量"},{font:"sys:icon",text:"0"},"消耗设为 1。"]]
...
data modify storage pc:lang lore.skill.warrior/yama_double set value [["释放 4 层",{color:"#7ABFF1",text:"火焰区域"},"并立即触发"],["敌人位置上的所有",{color:"#7ABFF1",text:"火焰区域"},"。"],[],[{color:"gray",text:"每回合开始时："}],["如果任何敌人的",{color:"#F1DE61",text:"血量"},{font:"sys:icon",text:"2"},"低于 25%，"],["他们将直接死亡。"]]
