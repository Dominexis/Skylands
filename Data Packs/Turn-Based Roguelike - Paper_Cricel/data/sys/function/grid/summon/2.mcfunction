...
execute summon minecraft:marker run function sys:grid/summon/per with storage pc:temp grid[0][0]

scoreboard players add #y2 pc.main 1
data remove storage pc:temp grid[0][0]

execute if data storage pc:temp grid[0][0] run function sys:grid/summon/2
execute unless data storage pc:temp grid[0][0] if data storage pc:temp grid[0] run function sys:grid/summon/3