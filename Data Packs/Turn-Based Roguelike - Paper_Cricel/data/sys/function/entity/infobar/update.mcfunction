...
execute unless data entity @s data.hidden.hp run function sys:entity/infobar/hpvalue
execute unless data entity @s data.hidden.hp run function sys:entity/infobar/hpbar
execute if data entity @s data.effects run function sys:entity/infobar/effect
