...
function sys:utils/passive/use {passive:"on_blocked"}

# fx
execute unless score #block_fx pc.main matches 0 run function sys:fx/text/use {text:{nbt:"sys.fx.blocked",storage:"pc:lang",interpret:1b}}
