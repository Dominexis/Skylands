...
$execute unless items entity 20060423-0-0-0-1 contents *[custom_data~{pc:{hotbar:"$(hotbar)"}}] run return run function sys:player/hotbar/update/2b with storage pc:temp update.slots.'$(hotbar)'

# else :
function sys:player/hotbar/update/3 with entity 20060423-0-0-0-1 item.components."minecraft:custom_data".pc
execute as 20060423-0-0-0-1 run function sys:item/update/2
