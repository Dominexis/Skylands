...
execute as @e[tag=pc.summon,type=minecraft:item_display] run rotate @s ~ 0

tag @e[tag=pc.summon,type=minecraft:item_display] remove pc.summon

# fx
playsound sys:teleport master @a ~ ~1024 ~ 0 1 0.5