...
item replace entity @s contents with ender_eye[custom_model_data={colors:[16726072]},item_model="mob:ender_eye"]
data remove entity @s data.schedule[{func:"item replace entity @s contents with ender_eye"}]
function sys:entity/schedule/use {func:"item replace entity @s contents with ender_eye",delay:10}
