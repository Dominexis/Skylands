...
execute positioned ^4 ^ ^ if function sys:entity/repel/is_stayable run scoreboard players set #left pc.main 1
execute positioned ^-4 ^ ^ if function sys:entity/repel/is_stayable run scoreboard players set #right pc.main 1
