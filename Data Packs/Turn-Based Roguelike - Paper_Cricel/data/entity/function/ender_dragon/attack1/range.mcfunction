...
execute rotated as @s positioned ^-4 ^ ^ run function sys:grid/range/use
execute rotated as @s positioned ^ ^ ^4 positioned ~-5.5 ~-100 ~-5.5 as @e[tag=pc.intent.now,type=marker,dx=10,dy=200,dz=10,limit=6] run function entity:ender_dragon/attack1/range_repeat
...
execute rotated as @s positioned ^8 ^ ^ run function sys:grid/range/use
execute rotated as @s positioned ^-8 ^ ^ run function sys:grid/range/use