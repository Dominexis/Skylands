...
execute if entity @s[tag=pc.entity.ender_dragon.debuff2.wave.border.clear] run return run function entity:ender_dragon/debuff2/wave/border/clear/main

execute if score @s pc.duration matches 2.. run function entity:ender_dragon/debuff2/wave/border/spin/main
