...
execute unless entity @e[tag=pc.atker,type=minecraft:end_crystal,distance=..0.25,limit=1] positioned ^ ^ ^0.25 run function entity:ender_dragon/crystal/attack1/beam