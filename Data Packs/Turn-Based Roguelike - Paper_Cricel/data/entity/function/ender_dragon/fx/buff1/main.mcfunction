...
execute if score @s pc.animation matches 20 run function entity:ender_dragon/fx/buff1/2
...
execute if score @s pc.animation matches 49.. at @s run function entity:ender_dragon/buff1/clear