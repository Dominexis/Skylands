...
execute positioned ~-1.5 ~-100 ~-1.5 as @e[tag=pc.grid,tag=!pc.grid.triggered,type=marker,dx=2,dy=200,dz=2,limit=1] at @s run function effect:flaming_touch/use
...
particle minecraft:lava ~ ~ ~ 0 0 0 0 20 force