...
rotate @e[tag=pc.summon,type=item_display,limit=1] ~ 0
data merge entity @e[tag=pc.summon,type=item_display,limit=1] {teleport_duration: 1}
tag @e[tag=pc.summon,type=item_display,limit=1] remove pc.summon
