...
tp @s ^ ^ ^1
execute if function sys:entity/hitbox/ally run return run function entity:enderman/walk1/fx/hit

execute if score @s pc.duration matches 30.. run function entity:enderman/walk1/fx/clear
