...
execute store result storage pc:temp temp.x float 0.1 run random value -15..15
execute store result storage pc:temp temp.y float 0.1 run random value -10..-5
execute store result storage pc:temp temp.z float 0.1 run random value -15..15
function sys:utils/macro/tp with storage pc:temp temp
