...
execute if score #mode pc.main matches 1 run function effect:dragon_scale/lose_hp/within_damage
execute if score #mode pc.main matches 0 run function effect:dragon_scale/lose_hp/over_damage
