...
data modify storage pc:temp passive.queue append value {func:"function effect:dragonbreath_area/mark/victim"}
...
execute unless score @s pc.thread_index matches 1.. at @s run function sys:utils/passive/queue with storage pc:temp passive.queue[0]