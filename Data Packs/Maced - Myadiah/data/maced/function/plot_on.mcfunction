...
summon minecraft:item 1792 65 256 {Glowing:1b,Age:-32768,Invulnerable:1b,Item:{id:"minecraft:mace",components:{"minecraft:enchantments":{"minecraft:wind_burst":1},"minecraft:unbreakable":{}},count:1}}

fill 1793 65 260 1791 65 265 minecraft:air