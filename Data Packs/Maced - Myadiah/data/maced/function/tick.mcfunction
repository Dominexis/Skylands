...
## Checkpoint
execute positioned 5888 64 -3328 as @a[distance=..250,tag=maced.in_game,team=sl.player] at @s if block ~ ~-1 ~ minecraft:gold_block run function sl:api/set_checkpoint
...
execute positioned 5888 64 -3328 as @a[distance=..250,tag=maced.in_game,scores={maced.Ylevel=..30},team=sl.player] run function sl:api/send_to_checkpoint
