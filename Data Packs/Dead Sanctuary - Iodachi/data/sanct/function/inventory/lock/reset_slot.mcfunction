...
$item replace entity @s $(slot) with minecraft:skull_pottery_sherd[minecraft:item_model="sanct:slot_lock",minecraft:tooltip_display={hide_tooltip:true},minecraft:item_name="",minecraft:max_stack_size=1,minecraft:custom_data={slot_lock:{$(slot):{},inventory:{}}}]