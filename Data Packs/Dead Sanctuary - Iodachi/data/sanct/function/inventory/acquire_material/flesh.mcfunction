execute if score #level sanct.numbers matches 1.. run return 1
scoreboard players set #level sanct.numbers 1

# Announcment
title @a[x=-2368,y=-16,z=2240,dx=126,dy=158,dz=126,predicate=sl:player] times 10 70 20
title @a[x=-2368,y=-16,z=2240,dx=126,dy=158,dz=126,predicate=sl:player] subtitle "§2Rotten Flesh§r spells added to §3Spellbook"
