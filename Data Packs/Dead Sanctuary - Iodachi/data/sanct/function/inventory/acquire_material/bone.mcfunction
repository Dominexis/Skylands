execute if score #level sanct.numbers matches 2.. run return 1
scoreboard players set #level sanct.numbers 2

# Announcement
title @a[x=-2368,y=-16,z=2240,dx=126,dy=158,dz=126,predicate=sl:player] times 10 70 20
title @a[x=-2368,y=-16,z=2240,dx=126,dy=158,dz=126,predicate=sl:player] subtitle "Spells using §7Bone§r added to §3Spellbook"
