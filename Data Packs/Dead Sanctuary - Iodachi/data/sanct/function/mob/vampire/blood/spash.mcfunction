...
execute if entity @a[limit=1,distance=..2] unless entity @e[type=area_effect_cloud,distance=..0.5,tag=sanct.vampire_splash] run summon area_effect_cloud ~ ~ ~ {potion_contents:{custom_color:-9109504},WaitTime:0,Radius:2f,Duration:200,Tags:["sanct.vampire_splash"]}