...
execute if entity @a[x=-2368,y=-16,z=2240,dx=126,dy=158,dz=126,predicate=sanct:spell/weapon_harvest_holding,limit=1,team=sl.player] run schedule function sanct:spell/alchemy/weapon_harvest/clock 3