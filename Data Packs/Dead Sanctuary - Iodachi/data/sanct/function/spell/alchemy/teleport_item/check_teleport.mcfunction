...
execute positioned ~ ~-0.25 ~ run effect give @a[distance=..0.000001,limit=1] minecraft:instant_health 1
execute positioned ~ ~-0.25 ~ run damage @a[distance=..0.000001,limit=1] 0.0000001
