...
# Sound
execute as @a[x=-2368,y=-16,z=2240,dx=126,dy=158,dz=126] at @s run playsound minecraft:block.conduit.attack.target player @s ~ ~ ~ 0.5 2 0.5
execute as @a[x=-2368,y=-16,z=2240,dx=126,dy=158,dz=126] at @s run playsound minecraft:block.conduit.ambient.short player @s ~ ~ ~ 0.5 2 0.5
