function sanct:mob/skeleton/spawn
tag @s add sanct.block_spawn

execute if score #summon_skeleton_iterator sanct.numbers matches ..1 run return 1
scoreboard players remove #summon_skeleton_iterator sanct.numbers 1
