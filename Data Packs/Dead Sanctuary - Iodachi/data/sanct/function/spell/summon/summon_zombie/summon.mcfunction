function sanct:mob/zombie/spawn
tag @s add sanct.block_spawn

execute if score #summon_zombie_iterator sanct.numbers matches ..1 run return 1
scoreboard players remove #summon_zombie_iterator sanct.numbers 1
