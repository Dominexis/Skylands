...
execute unless score resettingmap piecewiselantern.data matches 1 as @p[x=-1342,y=-10,z=-1360,dx=124,dy=15,dz=126,team=sl.player] at @s run playsound piecewiselantern:sfx.campfire_increment master @s ~ ~ ~ 1 1 0
