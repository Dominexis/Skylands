...
data modify block -1255 2 -1222 Items set value [{Slot:2b,components:{"minecraft:written_book_content":{author:"Broadrick Hunt",pages:[{raw:'"Lord Andel spoke in riddles again today.\\nI fear his mind is going faster than the doctors expected.\\nHis fits consist of screams for a light and a fear of darkness."'},{raw:'"He speaks of his parents.\\nI believe he fears them too, though of course they have passed many years ago."'}],resolved:1b,title:{raw:"20 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1254 3 -1222 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Broadrick Hunt",pages:[{raw:'"Lord Andel disappears for hours at a time.\\nI am unsure where he goes when he is not in his observatory, but the family fears for him.\\nLady Andel is quiet now, but I know she fears for her own fate as much as her husband\'s."'}],resolved:1b,title:{raw:"18 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1254 2 -1222 Items set value [{Slot:4b,components:{"minecraft:written_book_content":{author:"Broadrick Hunt",pages:[{raw:'"Everyone is gone.\\nI awoke today to find the house completely empty.\\nMilda and I are leaving today and going our separate ways.\\nI\'ve left the key to the door here just in case I need to return, though I hope I do not."'}],resolved:1b,title:{raw:"31 July 1877"}}},count:1,id:"minecraft:written_book"}]
data modify block -1254 2 -1220 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Front Door"'},count:1,id:"minecraft:trial_key"}]
...
# Main Room
data modify block -1269 2 -1281 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Mead"',"minecraft:item_model":"piecewiselantern:mead","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"}},count:1,id:"minecraft:potion"}]
data modify block -1293 2 -1290 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Wine"',"minecraft:item_model":"piecewiselantern:wine","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:night_vision"}},count:1,id:"minecraft:potion"}]
...
data modify block -1260 3 -1289 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'{"extra":[{"color":"dark_red","text":"KITCHEN "},"back to Milda.\\nI think he\'s hidden it away in his room again."],"text":"Father was yelling at Brannon to give the key to the "}'}],resolved:1b,title:{raw:"2 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1262 2 -1289 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'{"extra":[{"color":"dark_red","text":"LIBRARY "},"today while father wasn\'t there.\\nHe caught me and threw me out, said I had no business reading his books.\\nWas he hiding in there?\\nI did not hear the door to the hall open."],"text":"I snuck into the "}'},{raw:'"I told him I was looking for a book about Paris, but I don\'t think he believed me.\\nI know he has books in there about our family and this house that he doesn\'t want me to read."'}],resolved:1b,title:{raw:"7 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1257 3 -1284 Items set value [{Slot:12b,components:{"minecraft:written_book_content":{author:"Broadrick Hunt",pages:[{raw:'"NOTE TO SELF:\\nRepair the vent in Mistress Alice\'s room."'}],resolved:1b,title:{raw:"Vent"}}},count:1,id:"minecraft:written_book"},{Slot:14b,components:{"minecraft:custom_name":'"Screwdriver"',"minecraft:item_model":"piecewiselantern:screwdriver"},count:1,id:"minecraft:stick"}]
...
data modify block -1255 11 -1281 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Alice Andel",pages:[{raw:'"Father gave me a pretty pink necklace today!"'}],resolved:1b,title:{raw:"Pretty!"}}},count:1,id:"minecraft:written_book"},{Slot:2b,components:{"minecraft:written_book_content":{author:"Alice Andel",pages:[{raw:'"I added a date because I saw that Anna did it too.\\nI see her writing these notes all the time so I thought I should do so as well if I want to be smart like her.\\nI don\'t know what to write about though..."'}],resolved:1b,title:{raw:"10 July 1877"}}},count:1,id:"minecraft:written_book"},{Slot:4b,components:{"minecraft:written_book_content":{author:"Alice Andel",pages:[{raw:'"Annalise told me to write what I find interesting.\\nI think plants are interesting.\\nI think birds are interesting.\\nI think the house is interesting."'}],resolved:1b,title:{raw:"12 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1255 10 -1281 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Alice Andel",pages:[{raw:'"My vent is broken!\\nSounds like a bad thing but now I can get into Annalise\'s room even when her door is locked!\\nLuckily Broadrick leaves his ladder unattended..."'}],resolved:1b,title:{raw:"15 July 1877"}}},count:1,id:"minecraft:written_book"},{Slot:5b,components:{"minecraft:written_book_content":{author:"Alice Andel",pages:[{raw:'{"extra":[{"color":"dark_red","text":"OBSERVATORY"},", but other times I don\'t know where they go."],"text":"Father and Mother keep disappearing. Sometimes they are in the "}'}],resolved:1b,title:{raw:"26 July 1877"}}},count:1,id:"minecraft:written_book"}]
data modify block -1257 10 -1277 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Pink Necklace"',"minecraft:item_model":"piecewiselantern:pink"},count:1,id:"minecraft:pink_dye"}]
...
data modify block -1267 11 -1270 Items set value [{Slot:3b,components:{"minecraft:written_book_content":{author:"Brannon Andel Jr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"LIBRARY"}," without father\'s key!\\nI don\'t think Milda will be happy I snuck into the ",{"color":"dark_red","text":"KITCHEN"}," but now I\'ll win hide and seek every time!"],"text":"I found a way into the "}'},{raw:'{"extra":[{"color":"dark_red","text":"BATHROOM"}," I don\'t think anyone knows about!"],"text":"PS: I found a great hiding spot in the "}'}],resolved:1b,title:{raw:"NOT SECRETS!"}}},count:1,id:"minecraft:written_book"}]
data modify block -1262 10 -1273 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Blue Ring"',"minecraft:item_model":"piecewiselantern:blue"},count:1,id:"minecraft:blue_dye"}]
...
data modify block -1269 10 -1268 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Kitchen"'},count:1,id:"minecraft:trial_key"}]
...
data modify block -1302 2 -1273 Items set value [{Slot:3b,components:{"minecraft:written_book_content":{author:"Milda Rosh",pages:[{raw:'{"extra":[{"color":"dark_red","text":"OBSERVATORY "},"I fear he has forgotten his family."],"text":"Lord Andel no longer eats.\\nMost of the time he is absent from dinner and when he does appear he requests to take his meals away.\\nHe spends so much time in the "}'},{raw:'"Lady Andel is quiet now.\\nShe no longer objects to Lord Andel\'s disappearances."'}],resolved:1b,title:{raw:"Lord Andel"}}},count:1,id:"minecraft:written_book"},{Slot:5b,components:{"minecraft:written_book_content":{author:"Milda Rosh",pages:[{raw:'"Lady Andel now disappears with her meals as well.\\nI tell the children that they are busy with their work, though I can sense Mistress Annalise is suspicious.\\nBeing the eldest of the three I know she is more acutely aware of how strange their behavior has become."'}],resolved:1b,title:{raw:"Lady Andel"}}},count:1,id:"minecraft:written_book"}]
data modify block -1307 3 -1273 Items set value [{Slot:1b,count:1,id:"minecraft:rabbit"},{Slot:4b,count:1,id:"minecraft:carrot"},{Slot:11b,count:1,id:"minecraft:rabbit"},{Slot:14b,count:1,id:"minecraft:carrot"},{Slot:15b,count:1,id:"minecraft:rabbit"},{Slot:16b,count:1,id:"minecraft:carrot"},{Slot:17b,count:1,id:"minecraft:rabbit"},{Slot:19b,count:1,id:"minecraft:rabbit"},{Slot:21b,count:1,id:"minecraft:carrot"},{Slot:22b,count:1,id:"minecraft:rabbit"},{Slot:26b,count:1,id:"minecraft:carrot"}]
data modify block -1295 4 -1267 Items set value [{Slot:0b,count:1,id:"minecraft:chicken"},{Slot:3b,count:1,id:"minecraft:apple"},{Slot:5b,count:1,id:"minecraft:apple"},{Slot:7b,count:1,id:"minecraft:apple"},{Slot:10b,count:1,id:"minecraft:chicken"},{Slot:12b,count:1,id:"minecraft:apple"},{Slot:13b,count:1,id:"minecraft:chicken"},{Slot:15b,count:1,id:"minecraft:apple"},{Slot:16b,count:1,id:"minecraft:chicken"},{Slot:17b,count:1,id:"minecraft:chicken"},{Slot:19b,count:1,id:"minecraft:apple"},{Slot:20b,count:1,id:"minecraft:chicken"},{Slot:21b,count:1,id:"minecraft:chicken"},{Slot:24b,count:1,id:"minecraft:chicken"},{Slot:25b,count:1,id:"minecraft:apple"}]
...
data modify block -1299 2 -1267 Items set value [{Slot:1b,count:16,id:"minecraft:charcoal"}]
...
data modify block -1280 3 -1265 Items set value [{Slot:1b,components:{"minecraft:written_book_content":{author:"Broadrick Hunt",pages:[{raw:'{"extra":[{"color":"dark_red","text":"CELLAR "},"for Lord Andel\'s party.\\nThe door under the stairs is locked but I can access it from the ",{"color":"dark_red","text":"KITCHEN"}," if Milda will let me pass through \\"her domain.\\""],"text":"NOTE TO SELF:\\nBring up more mead from the "}'}],resolved:1b,title:{raw:"Mead"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1267 5 -1269 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"LIGHTHOUSE "},"beckons."],"text":"The time is near.\\nI fear for my life and my family\'s lives.\\nI am going the way of my parents, and theirs.\\nThe "}'},{raw:'"I saw it again last night.\\nI sat and watched.\\nIt watched me.\\nWe stared at each other...\\nInto each other..."'}],resolved:1b,title:{raw:"27 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1262 3 -1267 Items set value [{Slot:1b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"CELLAR "},"locked but I fear that Anna made it down somehow.\\nThe only way in is through the ",{"color":"dark_red","text":"LIBRARY"},", but I keep that locked too.\\nAnna keeps watching me and Emma, asking where we disappear to."],"text":"My mind is clear for the moment.\\nI keep the "}'}],resolved:1b,title:{raw:"26 July 1877"}}},count:1,id:"minecraft:written_book"}]
data modify block -1262 2 -1267 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Cellar"'},count:1,id:"minecraft:trial_key"}]
...
data modify block -1284 -5 -1287 Items set value [{Slot:12b,components:{"minecraft:custom_name":'"Mead"',"minecraft:item_model":"piecewiselantern:mead","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"}},count:1,id:"minecraft:potion"}]
data modify block -1284 -5 -1289 Items set value [{Slot:23b,components:{"minecraft:custom_name":'"Mead"',"minecraft:item_model":"piecewiselantern:mead","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"}},count:1,id:"minecraft:potion"}]
data modify block -1284 -4 -1290 Items set value [{Slot:1b,components:{"minecraft:custom_name":'"Mead"',"minecraft:item_model":"piecewiselantern:mead","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"}},count:1,id:"minecraft:potion"}]
data modify block -1283 -5 -1277 Items set value [{Slot:14b,components:{"minecraft:custom_name":'"Mead"',"minecraft:item_model":"piecewiselantern:mead","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:strong_swiftness"}},count:1,id:"minecraft:potion"}]
data modify block -1278 -4 -1290 Items set value [{Slot:14b,components:{"minecraft:custom_name":'"Wine"',"minecraft:item_model":"piecewiselantern:wine","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:night_vision"}},count:1,id:"minecraft:potion"}]
data modify block -1278 -5 -1288 Items set value [{Slot:20b,components:{"minecraft:custom_name":'"Wine"',"minecraft:item_model":"piecewiselantern:wine","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:night_vision"}},count:1,id:"minecraft:potion"}]
data modify block -1278 -4 -1287 Items set value [{Slot:15b,components:{"minecraft:custom_name":'"Wine"',"minecraft:item_model":"piecewiselantern:wine","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:night_vision"}},count:1,id:"minecraft:potion"}]
data modify block -1278 -5 -1277 Items set value [{Slot:5b,components:{"minecraft:custom_name":'"Wine"',"minecraft:item_model":"piecewiselantern:wine","minecraft:max_stack_size":64,"minecraft:potion_contents":{potion:"minecraft:night_vision"}},count:1,id:"minecraft:potion"}]
...
data modify block -1281 2 -1263 Items set value [{Slot:12b,components:{"minecraft:written_book_content":{author:"Broadrick Hunt",pages:[{raw:'{"extra":[{"color":"dark_red","text":"CELLAR "},"after fixing the broken glass or I\'ll find it in Mistress Alice\'s hands again..."],"text":"NOTE TO SELF:\\nTake the ladder back down to the "}'}],resolved:1b,title:{raw:"Ladder"}}},count:1,id:"minecraft:written_book"},{Slot:14b,components:{"minecraft:can_place_on":{predicates:[{blocks:"minecraft:pink_wool"}]}},count:1,id:"minecraft:ladder"}]
...
data modify block -1264 11 -1295 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'{"extra":[{"color":"dark_red","text":"CELLAR"}," today while father wasn\'t looking.\\nAt first I saw storage, but then I noticed a strange hallway with colored tiles.\\nWhat are behind those locked doors?"],"text":"I snuck down into the "}'}],resolved:1b,title:{raw:"8 July 1877"}}},count:1,id:"minecraft:written_book"},{Slot:2b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'{"extra":[{"color":"dark_red","text":"CELLAR"},".\\nHe spends so much time away.\\nI know he is up to something."],"text":"Father keeps disappearing into the "}'}],resolved:1b,title:{raw:"19 July 1877"}}},count:1,id:"minecraft:written_book"},{Slot:4b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'"Father says we are leaving tonight.\\nJust like that.\\nSomething feels terribly wrong."'}],resolved:1b,title:{raw:"30 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1262 11 -1295 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'"I\'ve decided to keep journals.\\nWe moved to the old house today and I figure I should write my feelings down instead of holding them in."'},{raw:'"Father calls this place Andel Manor.\\nApparently it\'s been in the family for generations, though I had not heard of it until a few weeks ago."'},{raw:'"Alice and Brannon keep calling it the \\"Big House\\", I prefer to call it, \\"Temporary.\\"\\nI\'ll be off to university soon.\\nIt could not come fast enough."'}],resolved:1b,title:{raw:"1 June 1877"}}},count:1,id:"minecraft:written_book"},{Slot:1b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'"Father gave us all gifts today.\\nHe said they belonged to our grandparents.\\nI think he\'s just trying to cheer us up after the move."'}],resolved:1b,title:{raw:"2 June 1877"}}},count:1,id:"minecraft:written_book"},{Slot:2b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'"Alice and Brannon have taken a liking to the house in the past week.\\nThey play hide and seek like I\'ve never seen before.\\nI can\'t blame them, really, the house and the grounds must seem huge to them.\\nThey\'ve even gotten me to play a few times."'},{raw:'"I use it as an excuse to wander places father doesn\'t want me to go.\\nHe says the house is old and can be dangerous.\\nHe and mother insist on fixing up the place.\\nI say let it crumble."'}],resolved:1b,title:{raw:"8 June 1877"}}},count:1,id:"minecraft:written_book"},{Slot:3b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'"I asked father why we moved here again.\\nHe gave me the same answer.\\n\\"This house belongs to the family and it is our responsibility to keep it alive.\\"\\nI can\'t help but think he has another motive he won\'t tell me."'}],resolved:1b,title:{raw:"11 June 1877"}}},count:1,id:"minecraft:written_book"},{Slot:4b,components:{"minecraft:written_book_content":{author:"Annalise Andel",pages:[{raw:'{"extra":[{"color":"dark_red","text":"CELLAR"}," locked.\\nWhat doesn\'t he want us to see?"],"text":"Father keeps the "}'}],resolved:1b,title:{raw:"20 June 1877"}}},count:1,id:"minecraft:written_book"}]
data modify block -1258 10 -1289 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"White Crystal"',"minecraft:item_model":"piecewiselantern:white"},count:1,id:"minecraft:white_dye"}]
data modify block -1266 11 -1289 Items set value [{Slot:12b,components:{"minecraft:written_book_content":{author:"Emma Andel",pages:[{raw:'{"extra":[{"color":"dark_red","text":"ATTIC"},".\\nIt\'s been over a month and you still haven\'t finished unpacking.\\nHere is the key.\\nDO NOT let your brother touch this, we\'ll never find him again."],"text":"Annalise, please finish putting your boxes in the "}'}],resolved:1b,title:{raw:"Unpack"}}},count:1,id:"minecraft:written_book"},{Slot:14b,components:{"minecraft:custom_name":'"Attic"'},count:1,id:"minecraft:trial_key"}]
...
data modify block -1299 11 -1267 Items set value [{Slot:1b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'"I lost several hours today.\\nI awoke back in my bed.\\nEmma said that Broadrick found me mumbling in the hallway."'}],resolved:1b,title:{raw:"17 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1299 10 -1273 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Emma Andel",pages:[{raw:'"Brannon.\\nWhere do you keep going off to?\\nI know you\'ll read this after I\'m asleep and I expect an answer tomorrow morning.\\nI do not wish to speak ill of each other in front of the children, but I worry for you."'}],resolved:1b,title:{raw:"Where are you?"}}},count:1,id:"minecraft:written_book"},{Slot:2b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"OBSERVATORY"},"."],"text":"My dear Emma, do not worry.\\nI am away again this morning in the "}'}],resolved:1b,title:{raw:"Do not worry."}}},count:1,id:"minecraft:written_book"},{Slot:4b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"LIGHTHOUSE"},".\\nI know I sound like my father but you have to trust me.\\nTonight, the 24th I believe it is, find me in the ",{"color":"dark_red","text":"OBSERVATORY "},"and I\'ll show you I\'m not crazy."],"text":"Emma.\\nI saw the "}'}],resolved:1b,title:{raw:"Not crazy."}}},count:1,id:"minecraft:written_book"}]
data modify block -1307 10 -1272 Items set value [{Slot:13b,components:{"minecraft:can_place_on":{predicates:[{blocks:"minecraft:polished_blackstone_bricks"}]},"minecraft:custom_name":'"Cellar Lab"'},count:1,id:"minecraft:pale_oak_button"}]
...
setblock -1278 -4 -1277 air
setblock -1273 -4 -1275 air
setblock -1274 -4 -1275 minecraft:redstone_block
data modify block -1268 -5 -1277 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Observatory"'},count:1,id:"minecraft:trial_key"}]
...
data modify block -1284 17 -1284 Items set value [{Slot:0b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"LIGHTHOUSE "},"to the north.\\nI must have been looking past it all this time.\\nMy small spyglass found it easily."],"text":"My father was right.\\nThere is a "}'}],resolved:1b,title:{raw:"11 July 1877"}}},count:1,id:"minecraft:written_book"},{Slot:4b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"LIGHTHOUSE"},".\\nWe are surrounded by nothing but forest, and yet, a ",{"color":"dark_red","text":"LIGHTHOUSE "},"stands."],"text":"There is nothing I want more than to explain this "}'}],resolved:1b,title:{raw:"16 July 1877"}}},count:1,id:"minecraft:written_book"}]
...
data modify block -1285 16 -1284 Items set value [{Slot:1b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"LIGHTHOUSE"},".\\nShe must believe me now."],"text":"It\'s time I bring Emma up here to see the "}'}],resolved:1b,title:{raw:"23 July 1877"}}},count:1,id:"minecraft:written_book"},{Slot:5b,components:{"minecraft:written_book_content":{author:"Brannon Andel Sr.",pages:[{raw:'{"extra":[{"color":"dark_red","text":"LIGHTHOUSE "},"tonight for the first time after several attempts.\\nShe feels its power.\\nShe knows now that we have no choice."],"text":"Emma finally saw the "}'},{raw:'{"extra":[{"color":"dark_red","text":"LIGHTHOUSE"},".\\nWe will take the ",{"color":"dark_red","text":"HEIRLOOMS "},"and complete the trials in the ",{"color":"dark_red","text":"CELLAR"},"."],"text":"Tomorrow we take the children to the "}'}],resolved:1b,title:{raw:"29 July 1877"}}},count:1,id:"minecraft:written_book"}]
data modify block -1280 19 -1295 Items set value [{Slot:13b,count:1,id:"minecraft:spyglass"}]
data modify block -1280 16 -1295 Items set value [{Slot:13b,components:{"minecraft:custom_name":'"Black Pocket Watch"',"minecraft:item_model":"piecewiselantern:black"},count:1,id:"minecraft:black_dye"}]
...
data modify block -1273 -5 -1308 Items set value [{Slot:13b,components:{"minecraft:can_place_on":{predicates:[{blocks:"minecraft:campfire"}]}},count:1,id:"minecraft:flint_and_steel"}]
