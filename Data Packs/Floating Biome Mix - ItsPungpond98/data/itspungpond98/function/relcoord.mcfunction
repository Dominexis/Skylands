...
tellraw @s [{"text": "Absolute Coords: "},{"score":{"name": "#abs_x", "objective": "itspungpond98.test"}},{"text": " "},{"score":{"name": "#abs_y", "objective": "itspungpond98.test"}},{"text": " "},{"score":{"name": "#abs_z", "objective": "itspungpond98.test"}}]
tellraw @s [{"text": "Relative Coords: ~"},{"score":{"name": "#rel_x", "objective": "itspungpond98.test"}},{"text": " ~"},{"score":{"name": "#rel_y", "objective": "itspungpond98.test"}},{"text": " ~"},{"score":{"name": "#rel_z", "objective": "itspungpond98.test"}}]
