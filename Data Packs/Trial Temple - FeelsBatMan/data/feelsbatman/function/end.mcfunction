...
playsound minecraft:ui.toast.challenge_complete master @a[team=sl.player,distance=..100] -256 39 -3815 1 0
title @a[team=sl.player,distance=..100,tag=feelsbatman.GRACZ] title [{"text":"D","color":"#99ff99"},{"text":"E","color":"#bbffbb"},{"text":"F","color":"#ddffdd"},{"text":"E","color":"#ddffdd"},{"text":"A","color":"#bbffbb"},{"text":"T","color":"#99ff99"}]
